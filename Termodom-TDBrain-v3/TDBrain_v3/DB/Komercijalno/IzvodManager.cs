                ...
                using(FbDataReader dr = cmd.ExecuteReader())
                {
                    while (dr.Read())
                    {
                        ...
                        dict.Add(izvodID, new Izvod()
                        {
                            ...
                            PozNaBroj = dr["POZNABROJ"] is DBNull ? null : dr["POZNABROJ"].ToString(),
                            ZiroRacun = dr["ZIRORACUN"] is DBNull ? null : dr["ZIRORACUN"].ToString(),
                            ...
                            VirmanID = dr["VIRMANID"] is DBNull ? null : (int?)Convert.ToInt32(dr["VIRMANID"]),
                            PoPDVBroj = dr["POPDVBROJ"] is DBNull ? null : dr["POPDVBROJ"].ToString(),
                        });
                    }
                }
            }
