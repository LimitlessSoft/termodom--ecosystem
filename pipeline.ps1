...
docker run -p 32776:80 -e ConnectionString_Komercijalno=$asd --name termodom--komercijalno-api -m 1G --restart=always -d limitlesssoft/termodom--komercijalno-api:$env:BUILD_NUMBER
