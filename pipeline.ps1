...
docker run -p 32775:80 --name termodom--td-brain --restart=always -d limitlesssoft/termodom--td-brain:$env:BUILD_NUMBER
...
docker run -p 32776:80 --name termodom--komercijalno-api --restart=always -d limitlesssoft/termodom--komercijalno-api:$env:BUILD_NUMBER