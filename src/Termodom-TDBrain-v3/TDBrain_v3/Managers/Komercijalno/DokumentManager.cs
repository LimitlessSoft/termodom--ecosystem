                ...
                using(FbDataReader dr = cmd.ExecuteReader())
                {
                    if(dr.Read())
                    {
                        return new Dokument()
                        {
                            ...
                            VrDokOut = dr["VRDOKOUT"] is DBNull ? null : Convert.ToInt32(dr["VRDOKOUT"]),
                            VrDokIn = dr["VRDOKIN"] is DBNull ? null : Convert.ToInt32(dr["VRDOKIN"]),
                            BrDokOut = dr["BRDOKOUT"] is DBNull ? null : Convert.ToInt32(dr["BRDOKOUT"]),
                            BrDokIn = dr["BRDOKIN"] is DBNull ? null : Convert.ToInt32(dr["BRDOKIN"]),
