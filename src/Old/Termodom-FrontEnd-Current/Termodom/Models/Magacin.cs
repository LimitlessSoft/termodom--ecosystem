	...
	public class Magacin
	{
		...
		)
		{
			HttpRequestMessage request = new HttpRequestMessage(
				HttpMethod.Post,
				Program.BaseAPIUrl + "/api/Magacin/Insert"
			);
			...
			request.Content = System.Net.Http.Json.JsonContent.Create<DTO.Webshop.MagacinDTO>(
				magacin
			);
		...
		public static Magacin Get(int id)
		{
			HttpRequestMessage request = new HttpRequestMessage(
				HttpMethod.Get,
				Program.BaseAPIUrl + "/api/Magacin/Get?id=" + id
			);
			...
			if (response.StatusCode == System.Net.HttpStatusCode.OK)
				return JsonConvert.DeserializeObject<Magacin>(
		...
		public static List<Magacin> List()
		{
			HttpRequestMessage request = new HttpRequestMessage(
				HttpMethod.Get,
				Program.BaseAPIUrl + "/api/Magacin/List"
			);
			...
			if (response.StatusCode == System.Net.HttpStatusCode.OK)
				return JsonConvert.DeserializeObject<List<Magacin>>(
					response.Content.ReadAsStringAsync().Result
				);
			else if (response.StatusCode == System.Net.HttpStatusCode.NoContent)
				return null;
		...
		public void Update()
		{
			HttpRequestMessage request = new HttpRequestMessage(
				HttpMethod.Post,
				Program.BaseAPIUrl + "/api/Magacin/Update"
			);
