	...
	public class Proizvod
	{
		...
		public void Update()
		{
			HttpRequestMessage request = new HttpRequestMessage(
				HttpMethod.Post,
				Program.BaseAPIUrl + "/Webshop/Proizvod/Update"
			);
		...
		public static Proizvod Get(int id)
		{
			...
			Task<DTO.Webshop.ProizvodGetDTO> wp = Task.Run<DTO.Webshop.ProizvodGetDTO>(() =>
			{
				HttpRequestMessage request = new HttpRequestMessage(
					HttpMethod.Get,
					Program.BaseAPIUrl + "/Webshop/Proizvod/Get?id=" + id
				);
				APIRequestFailedLog failedLog = null;
				HttpResponseMessage response = APIRequest.Send(request, out failedLog);

				if (response.StatusCode == System.Net.HttpStatusCode.OK)
					return JsonConvert.DeserializeObject<DTO.Webshop.ProizvodGetDTO>(
		...
		public static void Insert(Proizvod p)
		{
			HttpRequestMessage request = new HttpRequestMessage(
				HttpMethod.Post,
				Program.BaseAPIUrl + "/Webshop/Proizvod/Insert"
			);
		...
		public static Proizvod Get(string rel)
		{
			Task<DTO.Webshop.ProizvodGetDTO> wp = Task.Run<DTO.Webshop.ProizvodGetDTO>(() =>
			{
				HttpRequestMessage request = new HttpRequestMessage(
					HttpMethod.Get,
					Program.BaseAPIUrl + "/Webshop/Proizvod/Get?rel=" + rel
				);
		...
		public static List<Proizvod> List()
		{
			Task<List<DTO.Webshop.ProizvodGetDTO>> wp = Task.Run(() =>
			{
				HttpRequestMessage request = new HttpRequestMessage(
					HttpMethod.Get,
					Program.BaseAPIUrl + "/Webshop/Proizvod/List"
				);
				...
				if (response.StatusCode == System.Net.HttpStatusCode.OK)
					return JsonConvert.DeserializeObject<List<DTO.Webshop.ProizvodGetDTO>>(
						response.Content.ReadAsStringAsync().Result
					);
				else if (response.StatusCode == System.Net.HttpStatusCode.GatewayTimeout)
					throw new APIRequestTimeoutException(failedLog);
		...
		public static Proizvod Join(DTO.Webshop.ProizvodGetDTO proizvodGetDTO, Roba roba)
		{
			return new Proizvod()
			{
				...
				KupovinaSamoUTransportnomPakovanju =
					proizvodGetDTO.KupovinaSamoUTransportnomPakovanju,
		...
		public static List<Proizvod> Join(
			List<DTO.Webshop.ProizvodGetDTO> proizvodGetDTO,
			List<Roba> roba
		)
		{
