...
namespace Termodom.Controllers
{
    ...
    public class PorudzbinaController : Controller
    {
        ...
        public async Task<IActionResult> pStavkeAdministratorItemGet([FromBody] pStavkeAdministratorItemGetDTO itemGetDTO)
        {
            return await Task.Run<IActionResult>(() =>
            {
                Porudzbina.Stavka stavka = Porudzbina.Stavka.Get(itemGetDTO.StavkaID);
                DTO.Views.pStavkeAdministratorItemDTO pStavkeAdministratoraItemDTO = new DTO.Views.pStavkeAdministratorItemDTO(
                ...
                return View("/Views/Porudzbina/_pStavke_Administrator_Item.cshtml", pStavkeAdministratoraItemDTO);
            });
        }
        [HttpGet]
        ...
        public async Task<IActionResult> pPrekoTelefonaGetMaliP(string mobilni)
        {
            return await Task.Run(() =>
            {
                ...
                List<Porudzbina> porudzbine = porudzbineTask.Result.Where(t=>t.KontaktMobilni == mobilni).ToList();
                List<Porudzbina.Stavka> stavke = stavkeTask.Result;
                ...
                porudzbine.Sort((x, y) => y.Datum.CompareTo(x.Datum));
                return View("/Views/Porudzbina/_pPrikaz_Mali.cshtml", new Tuple<List<Porudzbina>, List<Korisnik>>(porudzbine, null));
            });
        }
        ...
        public async Task<IActionResult> DodajStavku(int porudzbinaID, int robaID, double kolicina) // TODO: StavkaAdd(...)
        {
            return await Task.Run<IActionResult>(() =>
            {
                ...
                if (proizvod.Result.KupovinaSamoUTransportnomPakovanju == 1 && kolicina % proizvod.Result.TransportnoPakovanje != 0)
                ...
                if (porudzbina.Result.JeProfi())
                {
                    ...
                    double rabat = ((artikal.Cena.VPCena / proizvod.Result.ProdajnaCena) - 1) * (-100);
                    
                    try
                    {
                        int newID = Porudzbina.Stavka.Insert(porudzbina.Result.ID, proizvod.Result.RobaID, kolicina, artikal.Cena.VPCena, rabat);
                ...
                {
                    Cenovnik cenovnik = Models.JednokratnaKupovina.CenovnikPoPorudzbini(porudzbina.Result);
        ...
        public async Task<IActionResult> StavkaKolicinaSet(int porudzbina, int stavka, string kolicina)
        {
            return await Task.Run<IActionResult>(() =>
            {
                Porudzbina p = Porudzbina.Get(porudzbina);
        ...
        public async Task<IActionResult> ObavestiRadnju(int id)
        {
            return await Task.Run<IActionResult>(() =>
            {
                ...
                string poruka = "Web porudzbina " + id + " koja pripada vasem magacinu je obradjena i povezana sa proracunom " + p.BrDokKom + ". www.termodom.rs";
        ...
        public async Task<IActionResult> ObavestiKorisnika(int id)
        {
            return await Task.Run<IActionResult>(() =>
            {
                ...
                string poruka = "WEB Porudzbina " + id + " je obradjena, novi status je: CEKA UPLATU - www.termodom.rs";
                SMS.SendSMS(mobilni, poruka, HttpContext.GetKorisnik().ID);
        ...
        public class pStavkeAdministratorItemGetDTO // TOOD: Wrong Namespace
        {
            ...
            public pStavkeAdministratorItemGetDTO(int stavkaID, Porudzbina porudzbina, Proizvod proizvod, Cenovnik ironCenovnik,
