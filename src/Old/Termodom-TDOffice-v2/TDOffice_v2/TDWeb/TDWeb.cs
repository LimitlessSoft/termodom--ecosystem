...
namespace TDOffice_v2.TDWeb
{
	public class TDWeb
	{
		public static string connectionString { get; set; } =
			"Server=174.138.184.42;Database=termodom_db_main;Uid=masdos_mdoas;Pwd=j1cnH38$;Pooling=false;SSL Mode=None";
		...
		public static void AzurirajIronCene()
		{
			...
			{
				Komercijalno.RobaUMagacinu r = rum.Where(x => x.RobaID == p.RobaID)
					.FirstOrDefault();
