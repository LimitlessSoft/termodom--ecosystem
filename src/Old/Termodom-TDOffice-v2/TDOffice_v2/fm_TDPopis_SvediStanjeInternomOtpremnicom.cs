	...
	public partial class fm_TDPopis_SvediStanjeInternomOtpremnicom : Form
	{
		...
		private void btn_Kreiraj_Click(object sender, EventArgs e)
		{
			...
			if (cb_IstaOtpremnicaZaViskoveiManjkove.Checked == true)
			{
				...
				int brDokOtpremnice = Komercijalno.Dokument.Insert(
				...
				{
					MessageBox.Show(
						"Doslo je do greske prilikmo kreiranja dokumenta otpremnice u komercijalnom poslovanju!"
					);
					return;
				}
				...
				foreach (Tuple<int, double> t in razlike)
				{
					Komercijalno.Stavka.Insert(
						DateTime.Now.Year,
						Komercijalno.Dokument.Get(_TDOffice_popis.Datum.Year, 19, brDokOtpremnice),
						_komercijalno_roba.Result.Where(x => x.ID == t.Item1).FirstOrDefault(),
						Komercijalno
							.RobaUMagacinu.BufferedList(TimeSpan.FromMinutes(10))
							.Where(x => x.MagacinID == IzMagacinaViskovi && x.RobaID == t.Item1)
							.FirstOrDefault(),
						t.Item2,
						0
					);
				...
				int brDokInternaMPKalkilacija = Komercijalno.Dokument.Insert(
					_TDOffice_popis.Datum.Year,
					18,
					"TD " + _TDOffice_popis.ID,
					null,
				...
				{
					MessageBox.Show(
						"Doslo je do greske prilikmo kreiranja dokumenta Interna MP kalkulacija u komercijalnom poslovanju!"
					);
					return;
				}
				foreach (Tuple<int, double> t in razlike)
				{
					Komercijalno.Stavka.Insert(
						DateTime.Now.Year,
						Komercijalno.Dokument.Get(
							_TDOffice_popis.Datum.Year,
							18,
							brDokInternaMPKalkilacija
						),
						_komercijalno_roba.Result.Where(x => x.ID == t.Item1).FirstOrDefault(),
						Komercijalno
							.RobaUMagacinu.BufferedList(TimeSpan.FromMinutes(10))
							.Where(x => x.MagacinID == UmagacinViskovi && x.RobaID == t.Item1)
							.FirstOrDefault(),
						t.Item2,
						0
					);
				...
				Komercijalno.Dokument dokOtpremnica = Komercijalno.Dokument.Get(
					_TDOffice_popis.Datum.Year,
					19,
					brDokOtpremnice
				);
				...
				Komercijalno.Dokument dokInternaMPKalkulacija = Komercijalno.Dokument.Get(
					_TDOffice_popis.Datum.Year,
					18,
					brDokInternaMPKalkilacija
				);
				...
				MessageBox.Show(
					"Kreiran novi dokumenti Otpremnica broj: "
						+ brDokOtpremnice.ToString()
						+ " i novi dokument Interna MP kalkulacoija broj: "
						+ brDokInternaMPKalkilacija.ToString()
				);
			}
			else
			{
				...
				{
					int brDokOtpremniceViskova = Komercijalno.Dokument.Insert(
						_TDOffice_popis.Datum.Year,
						19,
						"TD " + _TDOffice_popis.ID,
						null,
					...
					//Interna MP kalkulacija
					int brDokInternaMPKalkilacijaViskova = Komercijalno.Dokument.Insert(
						_TDOffice_popis.Datum.Year,
						18,
						"TD " + _TDOffice_popis.ID,
						null,
					...
					foreach (Tuple<int, double> t in razlikeViskovi)
					{
						Komercijalno.Stavka.Insert(
							...
							Komercijalno.Dokument.Get(
								_TDOffice_popis.Datum.Year,
								18,
								brDokInternaMPKalkilacijaViskova
							),
							_komercijalno_roba.Result.Where(x => x.ID == t.Item1).FirstOrDefault(),
							Komercijalno
								.RobaUMagacinu.BufferedList(TimeSpan.FromMinutes(10))
					...
					Komercijalno.Dokument dokOtpremnicaViskova = Komercijalno.Dokument.Get(
						_TDOffice_popis.Datum.Year,
						19,
						brDokOtpremniceViskova
					);
					...
					// Na Internoj MP Kalkulaciji
					Komercijalno.Dokument dokInternaMPKalkulacijaViskova =
						Komercijalno.Dokument.Get(
							_TDOffice_popis.Datum.Year,
							18,
							brDokInternaMPKalkilacijaViskova
					...
					MessageBox.Show(
						"Kreiran novi dokumenti Otpremnica broj: "
							+ brDokOtpremniceViskova.ToString()
							+ " i novi dokument Interna MP kalkulacija broj: "
							+ brDokInternaMPKalkilacijaViskova.ToString()
					);
				}

				if (razlikeManjkovi.Count > 0)
				{
					int brDokOtpremniceManjkova = Komercijalno.Dokument.Insert(
						_TDOffice_popis.Datum.Year,
						19,
						"TD " + _TDOffice_popis.ID,
						null,
					...
					foreach (Tuple<int, double> t in razlikeManjkovi)
					{
						Komercijalno.Stavka.Insert(
							...
							Komercijalno.Dokument.Get(
								_TDOffice_popis.Datum.Year,
								19,
								brDokOtpremniceManjkova
							),
							_komercijalno_roba.Result.Where(x => x.ID == t.Item1).FirstOrDefault(),
							Komercijalno
								.RobaUMagacinu.BufferedList(TimeSpan.FromMinutes(10))
								.Where(x =>
									x.MagacinID == IzMagacinaManjkovi && x.RobaID == t.Item1
								)
								.FirstOrDefault(),
							t.Item2,
							0
					...
					//Interna MP kalkulacija
					int brDokInternaMPKalkilacijaManjkova = Komercijalno.Dokument.Insert(
						_TDOffice_popis.Datum.Year,
						18,
						"TD " + _TDOffice_popis.ID,
						null,
					...
					foreach (Tuple<int, double> t in razlikeManjkovi)
					{
						Komercijalno.Stavka.Insert(
							...
							Komercijalno.Dokument.Get(
								_TDOffice_popis.Datum.Year,
								18,
								brDokInternaMPKalkilacijaManjkova
							),
							_komercijalno_roba.Result.Where(x => x.ID == t.Item1).FirstOrDefault(),
							Komercijalno
								.RobaUMagacinu.BufferedList(TimeSpan.FromMinutes(10))
								.Where(x => x.MagacinID == UMagacinManjkovi && x.RobaID == t.Item1)
								.FirstOrDefault(),
							t.Item2,
							0
						);
					...
					Komercijalno.Dokument dokOtpremnicaManjkova = Komercijalno.Dokument.Get(
						_TDOffice_popis.Datum.Year,
						19,
						brDokOtpremniceManjkova
					);
					...
					// Na Internoj MP Kalkulaciji
					Komercijalno.Dokument dokInternaMPKalkulacijaManjkova =
						Komercijalno.Dokument.Get(
							_TDOffice_popis.Datum.Year,
							18,
							brDokInternaMPKalkilacijaManjkova
					...
					MessageBox.Show(
						"Kreiran novi dokumenti Otpremnica broj: "
							+ brDokOtpremniceManjkova.ToString()
							+ " i novi dokument Interna MP kalkulacija broj: "
							+ brDokInternaMPKalkilacijaManjkova.ToString()
					);
				}
			}
		}
		...
		private void cb_IstaOtpremnicaZaViskoveiManjkove_CheckedChanged(object sender, EventArgs e)
		{
			...
			gb_SveViskoveOtpremnicom.Text = cb_IstaOtpremnicaZaViskoveiManjkove.Checked
				? "Sredi sve viskove i manjkove otpremnicom"
				: "Sredi sve viskove otpremnicom";
		}
	}
}
