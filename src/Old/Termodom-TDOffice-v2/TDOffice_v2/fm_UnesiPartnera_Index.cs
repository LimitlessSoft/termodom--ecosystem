...
namespace TDOffice_v2
{
	public partial class fm_UnesiPartnera_Index : Form
	{
		...
		public fm_UnesiPartnera_Index()
		{
			...
			{
				Dictionary<int, Komercijalno.Partner> part =
					new Dictionary<int, Komercijalno.Partner>();
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			if (
				!Program.TrenutniKorisnik.ImaPravo(137041)
				&& (
					Program.TrenutniKorisnik.KomercijalnoUserID == null
					|| dok.ZapID != Program.TrenutniKorisnik.KomercijalnoUserID
				)
			)
			{
				MessageBox.Show(
					"Dokument u kom zelite da promenite partnera nije vas dokument! Ukoliko je greska, "
