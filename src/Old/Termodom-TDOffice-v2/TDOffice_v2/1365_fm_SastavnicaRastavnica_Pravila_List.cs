	...
	public partial class _1365_fm_SastavnicaRastavnica_Pravila_List : Form
	{
		...
		private void ReloadPravila()
		{
			List<TDOffice.DokumentSastavnica> _dokumentSastavnica =
				TDOffice.DokumentSastavnica.ListByTip(TDOffice.Enums.DokumentSastavnicaTip.Pravilo);
		...
		private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (
				_1365_fm_SastavnicaRastavnica_Pravila_Index pi =
					new _1365_fm_SastavnicaRastavnica_Pravila_Index(
		...
		private void pictureBox1_Click(object sender, EventArgs e)
		{
			if (
				MessageBox.Show(
					"Sigurno zelite da kreirate novo pravilo?",
					"Novo pravilo",
			...
			)
			{
				int noviID = TDOffice.DokumentSastavnica.Insert(
					...
					TDOffice.Enums.DokumentSastavnicaTip.Pravilo,
					"NOVI"
				);
