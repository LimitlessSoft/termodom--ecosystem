...
namespace TDOffice_v2
{
    public static class Extensions
    {
        ...
        public static void DesniKlik_DatumRange(this Control container, EventHandler eventHandler = null)
        {
            List<DateTimePicker> list = container.Controls.OfType<DateTimePicker>().ToList();

            if (list.Count() != 2)
                throw new Exception("Kontrola mora imati tacno 2 DateTimePickera da bi ovo funkcionisalo!");

            DateTimePicker dtp1 = list[0];
            DateTimePicker dtp2 = list[1];

            if (dtp1.TabIndex == dtp2.TabIndex)
                throw new Exception("DateTimePickeri moraju imati razlicite vrednosti TabIndex varijable!");
            ...
            ToolStripMenuItem poslednjihDvadesetOsamDanaItem = new ToolStripMenuItem("Poslednjih 28 dana");
            ...
            {
                odDatuma.Value = new DateTime(DateTime.Now.Year, 1, 1);
                doDatuma.Value = new DateTime(DateTime.Now.Year, 1, DateTime.DaysInMonth(DateTime.Now.Year, 1));
            ...
            mesecFebruarItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 2, DateTime.DaysInMonth(DateTime.Now.Year, 2));
            ...
            mesecMartItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 3, DateTime.DaysInMonth(DateTime.Now.Year, 3));
            ...
            mesecAprilItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 4, DateTime.DaysInMonth(DateTime.Now.Year, 4));
            ...
            mesecMajItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 5, DateTime.DaysInMonth(DateTime.Now.Year, 5));
            ...
            mesecJunItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 6, DateTime.DaysInMonth(DateTime.Now.Year, 6));
            ...
            mesecJulItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 7, DateTime.DaysInMonth(DateTime.Now.Year, 7));
            ...
            mesecAvgustItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 8, DateTime.DaysInMonth(DateTime.Now.Year, 8));
            ...
            mesecSeptembarItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 9, DateTime.DaysInMonth(DateTime.Now.Year, 9));
            ...
            mesecOktobarItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 10, DateTime.DaysInMonth(DateTime.Now.Year, 10));
            ...
            mesecNovembarItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 11, DateTime.DaysInMonth(DateTime.Now.Year, 11));
            ...
            mesecDecembarItem.Click += (sender, args) =>
            {
                ...
                doDatuma.Value = new DateTime(DateTime.Now.Year, 12, DateTime.DaysInMonth(DateTime.Now.Year, 12));
        ...
        public static void DesniKlik_DatumRangeDGV(this Control container, EventHandler eventHandler = null)
        {
            ...
            danasItem.Click += (sender, args) =>
            {
                foreach(DataGridViewRow r in dgv.SelectedRows)
                {
                    ...
                    r.Cells["OdDatuma"].Value = new DateTime(dtselect.Year, dtNow.Month, DateTime.Now.Day);
                }
        ...
        public static string DivideOnCapital(this string sender, bool firstLetterIsCapital = true, bool separatedLetterCapital = false)
        {
            sender = sender.Trim();
            ...
            for(int i = 0; i < sender.Length; i++)
            {
                ...
                {
                    finish += ' ';
                    finish += separatedLetterCapital ? char.ToUpper(sender[i]) : char.ToLower(sender[i]);
                    continue;
                }
        ...
        {
            return sender.ToString(System.Globalization.CultureInfo.CurrentUICulture.DateTimeFormat.ShortDatePattern);
        }
        ...
        public static IEnumerable<Control> GetAllControlsAndSubControlls(this Control control)
        {
            ...
            return controls.SelectMany(ctrl => GetAllControlsAndSubControlls(ctrl))
                                      .Concat(controls);
        }
