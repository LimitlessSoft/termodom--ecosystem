...
namespace TDOffice_v2
{
	public partial class Menadzment_SvediStanje1934_Index : Form
	{
		...
		private TDOffice.Config<List<int>> razduzeni34 = TDOffice.Config<List<int>>.Get(
			TDOffice.ConfigParameter.SvedenoStanje1934
		);
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			Komercijalno.Dokument intOtp = Komercijalno.Dokument.Get(
				DateTime.Now.Year,
				19,
				intOtpMagacin12
			);
			List<Komercijalno.Stavka> stavkeOtpremnice = Komercijalno.Stavka.ListByDokument(
				DateTime.Now.Year,
				19,
				intOtpMagacin12
			);
			List<Komercijalno.Roba> komercijalnoRoba = Komercijalno.Roba.List(DateTime.Now.Year);
			List<Komercijalno.RobaUMagacinu> komercijalnoRobaUMagacinu =
				Komercijalno.RobaUMagacinu.ListByMagacinID(12);

			List<Komercijalno.Dokument> dokumenti = Komercijalno.Dokument.ListByVrDok(
				DateTime.Now.Year,
				34
			);
