...
namespace TDOffice_v2
{
	public partial class fm_Web_UredjivanjeCena_Item : Form
	{
		...
		private void fm_Web_UredjivanjeCena_Item_Load(object sender, EventArgs e)
		{
			...
			_komercijalnoRoba.Result.Add(
				new Komercijalno.Roba() { ID = -1, Naziv = " <<< Izaberi Robu >>>" }
			);
		...
		public void UcitajStavku(int stavkaID, DateTime analizaOd, DateTime analizaDo)
		{
			...
			Komercijalno.Roba kRoba = Komercijalno.Roba.Get(
				DateTime.Now.Year,
				_trenutnaWebStavka.RobaID
			);
			...
			referentiProizvod_cmb.SelectedValue =
				_trenutnaWebStavka.ReferentniProizvod == null
					? -1
					: _trenutnaWebStavka.ReferentniProizvod;
			referentiProizvod_cmb.Visible =
				_trenutnaWebStavka.Uslov
				== TDOffice.Enums.WebUredjivanjeCenaUslov.ReferentniProizvod;
		...
		private void uslovi_cmb_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			var usl = (TDOffice.Enums.WebUredjivanjeCenaUslov)
				Convert.ToInt32(uslovi_cmb.SelectedValue);
			...
			referentiProizvod_cmb.Visible =
				usl == TDOffice.Enums.WebUredjivanjeCenaUslov.ReferentniProizvod;
		...
		private void referentiProizvod_cmb_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			_trenutnaWebStavka.ReferentniProizvod = Convert.ToInt32(
				referentiProizvod_cmb.SelectedValue
			);
