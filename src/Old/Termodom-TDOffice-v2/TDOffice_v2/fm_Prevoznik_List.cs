...
namespace TDOffice_v2
{
    public partial class fm_Prevoznik_List : Form
    {
        ...
        private Task<TDOffice.Config<List<int>>> _prevoznici = TDOffice.Config<List<int>>.GetAsync((int)TDOffice.ConfigParameter.ListaIDevaPrevoznika);
        ...
        private Task OsveziDGVAsync()
        {
            return Task.Run(() =>
            {
                ...
                if (_prevoznici.Result != null && _prevoznici.Result.Tag != null)
                {
                    ...
                    {
                        TDOffice.Partner p = _tdOfficePartneri.Result.FirstOrDefault(x => x.ID == partnerID);
                ...
                this.Invoke((MethodInvoker)delegate
                {
                    ...
                    dataGridView1.Columns["Kontakt"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
                    status_lbl.Text = "";
        ...
        private void ukloniIzPrevoznikaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                int idPartnera = Convert.ToInt32(dataGridView1.Rows[dataGridView1.SelectedCells[0].RowIndex].Cells["ID"].Value);
