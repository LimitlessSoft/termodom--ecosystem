...
namespace TDOffice_v2
{
	public partial class fm_Ugovor_Index : Form
	{
		...
		private Task<List<Komercijalno.Partner>> _partnerniKomercijalno =
		...
		private void ResetUI()
		{
			...
			foreach (
				TDOffice.Enums.DokumentUgovorTip tip in Enum.GetValues(
					typeof(TDOffice.Enums.DokumentUgovorTip)
				)
			)
