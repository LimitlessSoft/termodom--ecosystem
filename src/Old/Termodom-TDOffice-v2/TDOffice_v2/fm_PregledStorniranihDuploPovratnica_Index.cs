	...
	public partial class fm_PregledStorniranihDuploPovratnica_Index : Form
	{
		...
		private void UcitajPodatke()
		{
			...
			)
			{
				...
				foreach (Komercijalno.Magacin m in Komercijalno.Magacin.List(con))
				{
					...
					while (true)
					{
						...
						TDOffice.SpecifikacijaNovca spec = TDOffice.SpecifikacijaNovca.Get(
							m.ID,
							date
						);
						...
						{
							Komercijalno.Dokument mpRacun = Komercijalno.Dokument.Get(
								con,
								15,
								storniraniMPRacun
							);
							...
							dr["Opis"] =
								"Storno Racun - "
								+ (
									mpRacun.NUID == Komercijalno.NacinUplate.Gotovina
										? "Gotovinski"
										: "Virmanski"
								);
			...
			DataGridViewComboBoxColumn stigaoFizickiCmbCol = new DataGridViewComboBoxColumn()
			{
				...
				Width = 100,
				HeaderCell = new DataGridViewColumnHeaderCell() { Value = "Stigao Fizicki" },
			...
			dataGridView1.Columns.Add(
				new DataGridViewTextBoxColumn()
				{
					...
					Width = 100,
					ReadOnly = true,
					HeaderCell = new DataGridViewColumnHeaderCell() { Value = "Datum" }
				}
			);
			dataGridView1.Columns.Add(
				new DataGridViewTextBoxColumn()
				{
					...
					Width = 250,
					ReadOnly = true,
					HeaderCell = new DataGridViewColumnHeaderCell() { Value = "Magacin" }
				}
			);
			dataGridView1.Columns.Add(
				new DataGridViewTextBoxColumn()
				{
					...
					Width = 80,
					ReadOnly = true,
					HeaderCell = new DataGridViewColumnHeaderCell() { Value = "BrDok" }
				}
			);
			dataGridView1.Columns.Add(
				new DataGridViewTextBoxColumn()
				{
					...
					Width = 150,
					ReadOnly = true,
					HeaderCell = new DataGridViewColumnHeaderCell() { Value = "Opis" }
				}
			);
			dataGridView1.Columns.Add(
				new DataGridViewTextBoxColumn()
				{
					...
					Width = 100,
					ReadOnly = true,
					HeaderCell = new DataGridViewColumnHeaderCell() { Value = "Vrednost" }
				}
			);
