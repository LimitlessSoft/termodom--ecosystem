...
namespace TDOffice_v2.TDOffice
{
	public class BiznisPlan
	{
		...
		public Dictionary<string, double> PlaniraniTroskovi { get; set; } =
		...
		{
			Config<Dictionary<int, BiznisPlan>> c = Config<Dictionary<int, BiznisPlan>>.Get(
				ConfigParameter.BiznisPlan
			);
			if (c == null)
			{
