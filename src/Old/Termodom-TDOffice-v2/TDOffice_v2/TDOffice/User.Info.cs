...
namespace TDOffice_v2.TDOffice
{
	public partial class User
	{
		public class Info
		{
			...
			public Dictionary<TipAutomatskogObavestenja, bool> PrimaObavestenja = new Dictionary<
		...
		void asd()
		{
			...
			Dictionary<TipAutomatskogObavestenja, bool> objasnjenjePrimaObavestenja =
				new Dictionary<TipAutomatskogObavestenja, bool>();
			objasnjenjePrimaObavestenja[TipAutomatskogObavestenja.NakonRazduzenjaRobe] = true;
			bool daLiPrimaSledeceObavestenje = objasnjenjePrimaObavestenja[
				TipAutomatskogObavestenja.NakonRazduzenjaRobe
			];
