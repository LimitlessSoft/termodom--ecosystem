...
namespace TDOffice_v2
{
	public partial class _7_fm_TDPopis_Index : Form
	{
		...
		private List<
			Tuple<int, double>
		> _ukupni_izlaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice { get; set; }
		private List<
			Tuple<int, double>
		> _ukupni_ulaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice { get; set; }
		private Task<
			List<Komercijalno.Dokument>
		> _komercijalno_izlazni_dokumenti_izmedju_datuma_popisa_komercijalno_tdoffice { get; set; }
		private Task<
			List<Komercijalno.Dokument>
		> _komercijalno_ulazni_dokumenti_izmedju_datuma_popisa_komercijalno_tdoffice { get; set; }

		private bool _ukupni_izlaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice_loaded { get; set; } =
			false;
		private bool _ukupni_ulaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice_loaded { get; set; } =
			false;
		...
		private ManualResetEventSlim _karticaRobeInitializedMRE { get; set; } =
		...
		public static List<int> izlazniVrDok { get; set; } =
			new List<int>() { 15, 19, 17, 23, 13, 14, 27, 25, 28 };
		public static List<int> ulazniVrDok { get; set; } =
			new List<int>() { 0, 11, 18, 16, 22, 1, 2, 26, 29, 30 };
		...
		public _7_fm_TDPopis_Index(TDOffice.DokumentPopis popis)
		{
			...
			_komercijalno_robaUMagacinu = Komercijalno.RobaUMagacinu.ListByMagacinIDAsync(
				popis.MagacinID
			);

			dataGridView1.Size = new Size(panel2.Width - 10, panel2.Height - groupBox1.Height - 20);
			detaljnaAnalizaToggleToolStripMenuItem1.Text = LocalSettings
				.Settings
				.TDPopis_PrikaziDetaljnuAnalizu
				? "Sakrij detaljnu analizu"
		...
		private void _7_fm_TDPopis_Index_Load(object sender, EventArgs e)
		{
			...
			ColorDGV();
			SetDGV2();
			_komercijalno_stavka_za_magacin = Komercijalno.Stavka.ListByMagacinIDAsync(
				_TDOffice_popis.MagacinID
			);
			_komercijalno_dokumenti_za_magacin = Komercijalno.Dokument.ListByMagacinIDAsync(
				_TDOffice_popis.Datum.Year,
				_TDOffice_popis.MagacinID
			);
			_komercijalno_izlazni_dokumenti_izmedju_datuma_popisa_komercijalno_tdoffice = Task.Run(
				() =>
				{
					return _komercijalno_dokumenti_za_magacin
						.Result.Where(x =>
							izlazniVrDok.Contains(x.VrDok)
							&& x.Datum >= _Komercijalno_popis.Datum
							&& x.MagacinID == _TDOffice_popis.MagacinID
						)
						.ToList();
				}
			);
			...
			if (Program.TrenutniKorisnik.ImaPravo(700004))
				unosStavkeTipUnosa_cmb.Checked = LocalSettings
					.Settings
					.TDPopis_PrilikomUnosaStavkeUnosimNarucenuKolicinu;
			else
		...
		private void SetupDGV()
		{
			...
			dataGridView1.Columns["KomercijalnoPopisKolicina"].DefaultCellStyle.Alignment =
				DataGridViewContentAlignment.MiddleRight;
			dataGridView1.Columns["KomercijalnoPopisKolicina"].HeaderText =
				"(1) Komercijalno Popis";
			dataGridView1.Columns["KomercijalnoPopisKolicina"].DefaultCellStyle.BackColor = System
				.Drawing
				.Color
				.Wheat;
			...
			dataGridView1.Columns["Kolicina"].ReadOnly =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan ? false : true;
			if (_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan)
				dataGridView1.Columns["Kolicina"].DefaultCellStyle.BackColor = System
					.Drawing
					.Color
					.Yellow;

			dataGridView1.Columns["Skart"].Width = 80;
			dataGridView1.Columns["Skart"].DefaultCellStyle.Alignment =
				DataGridViewContentAlignment.MiddleRight;
			dataGridView1.Columns["Skart"].DefaultCellStyle.Format = "#,##0.00";
			dataGridView1.Columns["Skart"].HeaderText = "(3) Skart";
			dataGridView1.Columns["Skart"].ReadOnly =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan ? false : true;
			if (_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan)
				dataGridView1.Columns["Skart"].DefaultCellStyle.BackColor = System
					.Drawing
					.Color
					.LightYellow;

			dataGridView1.Columns["PorucenaKolicina"].Width = 80;
			dataGridView1.Columns["PorucenaKolicina"].DefaultCellStyle.Alignment =
				DataGridViewContentAlignment.MiddleRight;
			...
			dataGridView1.Columns["PorucenaKolicina"].Visible =
				_TDOffice_popis.KomercijalnoNarudzbenicaBrDok == null ? false : true;
			dataGridView1.Columns["PorucenaKolicina"].ReadOnly =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan ? false : true;
			if (_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan)
				dataGridView1.Columns["PorucenaKolicina"].DefaultCellStyle.BackColor = System
					.Drawing
					.Color
					.Yellow;
			...
			dataGridView1.Columns["Cena"].DefaultCellStyle.Alignment =
				DataGridViewContentAlignment.MiddleRight;
			dataGridView1.Columns["Cena"].DefaultCellStyle.Format = "#,##0.00";
			dataGridView1.Columns["Cena"].HeaderText =
				"(5) Cena na dan " + _Komercijalno_popis.Datum.ToString("dd.MM.yyyy");
			dataGridView1.Columns["Cena"].ReadOnly = true;

			dataGridView1.Columns["VrednostPR"].Width = 130;
			dataGridView1.Columns["VrednostPR"].DefaultCellStyle.Alignment =
				DataGridViewContentAlignment.MiddleRight;
			dataGridView1.Columns["VrednostPR"].DefaultCellStyle.Format = "#,##0.00";
			dataGridView1.Columns["VrednostPR"].DefaultCellStyle.BackColor = System
				.Drawing
				.Color
				.Wheat;
			dataGridView1.Columns["VrednostPR"].HeaderText = "(6) Vrednost Porucene Robe [1 * 4]";
			dataGridView1.Columns["VrednostPR"].ReadOnly = true;
			dataGridView1.Columns["VrednostPR"].Visible =
				_Komercijalno_narudzbenica == null ? false : true;

			dataGridView1.Columns["StanjeNaDanPopisaKomercijalno"].Width = 80;
			dataGridView1.Columns["StanjeNaDanPopisaKomercijalno"].DefaultCellStyle.Alignment =
				DataGridViewContentAlignment.MiddleRight;
			dataGridView1.Columns["StanjeNaDanPopisaKomercijalno"].DefaultCellStyle.Format =
				"#,##0.00";
			dataGridView1.Columns["StanjeNaDanPopisaKomercijalno"].HeaderText =
				"(7) Stanje na dan " + _Komercijalno_popis.Datum.ToString("dd.MM.yyyy");
			dataGridView1.Columns["StanjeNaDanPopisaKomercijalno"].ReadOnly = true;
			dataGridView1.Columns["StanjeNaDanPopisaKomercijalno"].Visible =
				Program.TrenutniKorisnik.ImaPravo(700801) ? true : false;

			dataGridView1.Columns["Razlika"].Width = 80;
			dataGridView1.Columns["Razlika"].DefaultCellStyle.Alignment =
				DataGridViewContentAlignment.MiddleRight;
			...
			dataGridView1.Columns["Razlika"].Visible = Program.TrenutniKorisnik.ImaPravo(700802)
				? true
				: false;

			dataGridView1.Columns["VrednostRazlike"].Width = 130;
			dataGridView1.Columns["VrednostRazlike"].DefaultCellStyle.Alignment =
				DataGridViewContentAlignment.MiddleRight;
			...
			dataGridView1.Columns["VrednostRazlike"].Visible = Program.TrenutniKorisnik.ImaPravo(
				700803
			)
				? true
				: false;
		...
		{
			analitikaStavke_gbx.Visible = Program.TrenutniKorisnik.ImaPravo(700810)
				? LocalSettings.Settings.TDPopis_PrikaziDetaljnuAnalizu
				: false;
			dataGridView1.Height = panel2.Height - panel3.Height - 6;

			this.dokumentStatus_btn.Text =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan
					? "Zakljucaj"
					: "Otkljucaj";
			this.BackColor =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan
			...
			this.referent_txt.Text = _korisnici
				.Result.Where(x => x.ID == _TDOffice_popis.UserID)
				.FirstOrDefault()
				.Username;

			if (_TDOffice_popis.KomercijalnoPopisBrDok != null)
			{
				_Komercijalno_popis = Komercijalno.Dokument.Get(
					_TDOffice_popis.Datum.Year,
					7,
					(int)_TDOffice_popis.KomercijalnoPopisBrDok
				);
				if (_Komercijalno_popis != null)
					this.popisKomercijalnoPopisDatum_txt.Text = _Komercijalno_popis.Datum.ToString(
						"dd.MM.yyyy"
					);
				else
			...
			if (_TDOffice_popis.KomercijalnoNarudzbenicaBrDok != null)
			{
				_Komercijalno_narudzbenica = Komercijalno.Dokument.Get(
					_TDOffice_popis.Datum.Year,
					33,
					(int)_TDOffice_popis.KomercijalnoNarudzbenicaBrDok
				);
				if (_Komercijalno_narudzbenica != null)
					this.popisKomercijalnoNarudzbenicaDatum_txt.Text =
						_Komercijalno_narudzbenica.Datum.ToString("dd.MM.yyyy");
				else
					this.popisKomercijalnoPopisDatum_txt.Text = "Greska";
			}
			...
			this.komercijalnoPopis_txt.Text =
				_TDOffice_popis.KomercijalnoPopisBrDok == null
					? ""
					: _TDOffice_popis.KomercijalnoPopisBrDok.ToString();
			this.komercijalnoNarudzbenica_txt.Text =
				_TDOffice_popis.KomercijalnoNarudzbenicaBrDok == null
					? ""
					: _TDOffice_popis.KomercijalnoNarudzbenicaBrDok.ToString();
			Komercijalno.Magacin magacin = Komercijalno.Magacin.Get(
				DateTime.Now.Year,
				_TDOffice_popis.MagacinID
			);
		...
		private void NamestiUIPoZaduzenju()
		{
			...
			{
				this.kreirajDokumentRazduzenjaZaduzenja_btn.Enabled =
					_TDOffice_popis.Status == TDOffice.DokumentStatus.Zakljucan ? true : false;
			}
			else
			{
				this.kreirajDokumentRazduzenjaZaduzenja_btn.Enabled = false;
				this.kreirajDokumentRazduzenjaZaduzenja_btn.Text =
					_TDOffice_popis.ZaduzenjeBrDokKomercijalno.ToString();
			}
		}
		...
		private void ReloadStavki()
		{
			...
			{
				Komercijalno.Roba rob = _komercijalno_roba
					.Result.Where(x => x.ID == s.RobaID)
					.FirstOrDefault();
				Komercijalno.Stavka komercijalnoPopisStavka =
					_komercijalno_popis_stavke == null
						? null
						: _komercijalno_popis_stavke
							.Result.Where(x => x.RobaID == rob.ID)
							.FirstOrDefault();
				Komercijalno.Stavka komercijalnoNarudzbenicaStavka =
					_komercijalno_narudzbenica_stavke == null
						? null
						: _komercijalno_narudzbenica_stavke
							.Result.Where(x => x.RobaID == rob.ID)
							.FirstOrDefault();
				...
				dr["Naziv"] = rob.Naziv;
				dr["KomercijalnoPopisStavkaID"] =
					komercijalnoPopisStavka == null ? -1 : komercijalnoPopisStavka.StavkaID;
				dr["KomercijalnoPopisKolicina"] =
					komercijalnoPopisStavka == null ? -1 : komercijalnoPopisStavka.Kolicina;
				dr["KomercijalnoNarudzbenicaStavkaID"] =
					komercijalnoNarudzbenicaStavka == null
						? -1
						: komercijalnoNarudzbenicaStavka.StavkaID;
				if (s.Kolicina != null)
				...
				dr["VrednostPR"] =
					komercijalnoPopisStavka == null
						? -999999
						: komercijalnoPopisStavka.Kolicina * s.ProdajnaCena;
				double stanjeNaDanPopisaKomercijalno =
					_Komercijalno_popis == null
						? -999999
						: Komercijalno.Procedure.StanjeDoDatuma(
							_Komercijalno_popis.Datum,
							_TDOffice_popis.MagacinID,
							rob.ID
						);
				...
				double razlika =
					komercijalnoPopisStavka == null
						? -999999
						: komercijalnoPopisStavka.Kolicina - stanjeNaDanPopisaKomercijalno;
		...
		{
			if (_Komercijalno_popis != null)
				_komercijalno_popis_stavke = Komercijalno.Stavka.ListByDokumentAsync(
					DateTime.Now.Year,
					_Komercijalno_popis.VrDok,
					_Komercijalno_popis.BrDok
				);
		}
		...
		{
			if (_Komercijalno_narudzbenica != null)
				_komercijalno_narudzbenica_stavke = Komercijalno.Stavka.ListByDokumentAsync(
					DateTime.Now.Year,
					_Komercijalno_narudzbenica.VrDok,
					_Komercijalno_narudzbenica.BrDok
				);
		}
		...
		private void LoadUkupniIzlazSvihStavkiRelativno()
		{
			try
			{
				_ukupni_izlaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice =
				...
				for (int i = 0; i < workers; i++)
				{
					...
					Thread t = new Thread(() =>
					{
						...
						for (
							int y = startIndex;
							y < (ti == (workers - 1) ? dataGridView1.Rows.Count : endIndex);
							y++
						)
						{
							if (this == null || this.IsDisposed)
							...
							int robaID = Convert.ToInt32(
								dataGridView1.Rows[y].Cells["RobaID"].Value
							);
							_ukupni_izlaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice.Add(
								new Tuple<int, double>(
									robaID,
									GetUkupniIzlazStavkeRelativno(robaID)
								)
							);
						}
						done++;
				...
				_ukupni_izlaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice_loaded =
					true;
				this.Invoke(
					(MethodInvoker)
						delegate
						{
							analitikaPojedinacneStavkeIzlazRelativan_txt.BackColor =
		...
		private void LoadUkupniUlazSvihStavkiRelativno()
		{
			try
			{
				_ukupni_ulaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice =
					new List<Tuple<int, double>>();
				foreach (DataGridViewRow r in dataGridView1.Rows)
				{
					...
					_ukupni_ulaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice.Add(
						new Tuple<int, double>(robaID, GetUkupniUlazStavkeRelativno(robaID))
					);
				}
				_ukupni_ulaz_stavki_komercijalno_relativno_datumima_komercijalno_tdoffice_loaded =
					true;
				this.Invoke(
					(MethodInvoker)
						delegate
						{
							analitikaPojedinacneStavkeUlazRelativan_txt.BackColor =
								Control.DefaultBackColor;
						}
				);
			}
		...
		private double GetUkupniIzlazStavkeRelativno(int robaID)
		{
			...
			foreach (
				Komercijalno.Dokument d in _komercijalno_izlazni_dokumenti_izmedju_datuma_popisa_komercijalno_tdoffice.Result
			)
				ukupniIzlaz += _komercijalno_stavka_za_magacin
					.Result.Where(x =>
						x.RobaID == robaID && x.VrDok == d.VrDok && x.BrDok == d.BrDok
					)
					.Sum(y => y.Kolicina);
		...
		private double GetUkupniUlazStavkeRelativno(int robaID)
		{
			...
			double ukupniUlaz = 0;
			foreach (
				Komercijalno.Dokument d in _komercijalno_ulazni_dokumenti_izmedju_datuma_popisa_komercijalno_tdoffice.Result
			)
				ukupniUlaz += _komercijalno_stavka_za_magacin
					.Result.Where(x =>
						x.RobaID == robaID && x.VrDok == d.VrDok && x.BrDok == d.BrDok
					)
					.Sum(y => y.Kolicina);
		...
		public void DodajRobuUPopis(Komercijalno.RobaUMagacinu[] robaArray)
		{
			...
			Task<List<Komercijalno.RobaUMagacinu>> robaUMagacinu =
				Komercijalno.RobaUMagacinu.ListByMagacinIDAsync(_TDOffice_popis.MagacinID);

			Parallel.ForEach(
				workingRoba,
				roba =>
				{
					List<Komercijalno.Dokument> sviOtkljucaniIzlazniDokumentiZaMagacin =
						_komercijalno_dokumenti_za_magacin
							.Result.Where(x =>
								(izlazniVrDok.Contains(x.VrDok) || ulazniVrDok.Contains(x.VrDok))
								&& x.Flag == 0
								&& x.KodDok == 0
							)
							.ToList();
					...
					//skidam vrdok 18
					sviOtkljucaniIzlazniDokumentiZaMagacin.RemoveAll(x =>
						x.VrDok == 18 || x.VrDok == 0
					);
					List<Komercijalno.Stavka> komercijalneStavkeZaRobaID =
						_komercijalno_stavka_za_magacin
							.Result.Where(x => x.RobaID == roba.RobaID)
							.ToList();

					foreach (Komercijalno.Dokument dok in sviOtkljucaniIzlazniDokumentiZaMagacin)
					{
						if (
							komercijalneStavkeZaRobaID
								.Where(x =>
									x.VrDok != 0 && x.VrDok == dok.VrDok && x.BrDok == dok.BrDok
								)
								.FirstOrDefault() != null
						)
						{
							MessageBox.Show(
								"Stavka postoji u nekom dokumentu koji nije zakljucan! - VrDok: "
									+ dok.VrDok
									+ " - BrDok: "
									+ dok.BrDok
							);
					...
					int newStavkaID = TDOffice.StavkaPopis.Insert(
						con1,
						_TDOffice_popis.ID,
						roba.RobaID,
						roba.ProdajnaCena,
					...
					if (_TDOffice_popis.KomercijalnoPopisBrDok != null)
						if (
							Komercijalno.Stavka.Insert(
								...
								_Komercijalno_popis,
								_komercijalno_roba
									.Result.Where(x => x.ID == roba.RobaID)
									.FirstOrDefault(),
								robaUMagacinu
									.Result.Where(x => x.RobaID == roba.RobaID)
									.FirstOrDefault(),
								(insert_kolicina == null ? 0 : (double)insert_kolicina)
									+ GetUkupniIzlazStavkeRelativno(roba.RobaID)
									- GetUkupniUlazStavkeRelativno(roba.RobaID),
								0
							) == -1
						)
							MessageBox.Show(
								"Doslo je do greske prilikom kreiranje stavke u komercijalnom popisu!"
							);
					...
					if (_TDOffice_popis.KomercijalnoNarudzbenicaBrDok != null)
						if (
							...
							MessageBox.Show(
								"Doslo je do greske prilikom kreiranje stavke u komercijalnoj narudbenici!"
							);
		...
		private void obrisiToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			int komercijalnoPopisStavkaID = Convert.ToInt32(
				dataGridView1.SelectedRows[0].Cells["KomercijalnoPopisStavkaID"].Value
			);
			int komercijalnoNarudzbenicaStavkaID = Convert.ToInt32(
				dataGridView1.SelectedRows[0].Cells["KomercijalnoNarudzbenicaStavkaID"].Value
			);
		...
		{
			if (
				!Program.TrenutniKorisnik.ImaPravo(
					_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan ? 700002 : 700003
				)
			)
			{
				TDOffice.Pravo.NematePravoObavestenje(
					_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan ? 700002 : 700003
				);
				return;
			}
			...
			if (_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan)
			{
				if (
					MessageBox.Show(
						"Da li sigurno zelite zakljucati dokument?",
						"Zakljucati?",
			...
			else
			{
				...
				{
					MessageBox.Show(
						"Po ovom dokumentu je kreiran dokument zaduzenja/radzuzenja te se ne moze menjati!"
					);
					return;
				}
			}

			_TDOffice_popis.Status =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan
					? TDOffice.DokumentStatus.Zakljucan
					: TDOffice.DokumentStatus.Otkljucan;
			...
			dataGridView1.Columns["Kolicina"].ReadOnly =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan ? false : true;
			dataGridView1.Columns["Kolicina"].DefaultCellStyle.BackColor =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan
			...
			dataGridView1.Columns["PorucenaKolicina"].ReadOnly =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan ? false : true;
			dataGridView1.Columns["PorucenaKolicina"].DefaultCellStyle.BackColor =
				_TDOffice_popis.Status == TDOffice.DokumentStatus.Otkljucan
					? System.Drawing.Color.Yellow
					: System.Drawing.Color.White;
		...
		{
			using (
				fm_Dokument_Komentar kom = new fm_Dokument_Komentar(_TDOffice_popis.InterniKomentar)
			)
			{
				kom.KomentarSacuvan += (noviKomentar) =>
				{
		...
		{
			LocalSettings.Settings.TDPopis_PrilikomUnosaStavkeUnosimNarucenuKolicinu =
				unosStavkeTipUnosa_cmb.Checked;
		...
		private void dataGridView1_CellValidated(object sender, DataGridViewCellEventArgs e)
		{
			...
			{
				int stavkaID = Convert.ToInt32(
					dataGridView1.Rows[e.RowIndex].Cells["StavkaID"].Value
				);
				...
				double newValueForKomercijalnoPopis = (
					GetUkupniIzlazStavkeRelativno(robaID)
					+ newValue
					- GetUkupniUlazStavkeRelativno(robaID)
				);

				if (
					_TDOffice_popis.KomercijalnoPopisBrDok != null
					&& Convert.ToInt32(
						dataGridView1.Rows[e.RowIndex].Cells["KomercijalnoPopisStavkaID"].Value
					) != -1
				)
				{
					int komercijalnoPopisStavkaID = Convert.ToInt32(
					...
					Komercijalno.Stavka s = Komercijalno.Stavka.Get(
						DateTime.Now.Year,
						komercijalnoPopisStavkaID
					);
					s.Kolicina = newValueForKomercijalnoPopis;
					s.Update(DateTime.Now.Year);

					LoadKomercijalnoPopisStavke();
					dataGridView1.Rows[e.RowIndex].Cells["KomercijalnoPopisKolicina"].Value =
						_komercijalno_popis_stavke
							.Result.Where(x => x.StavkaID == komercijalnoPopisStavkaID)
							.FirstOrDefault()
							.Kolicina;
				}

				double cenaStavkeNaDan = Convert.ToDouble(
					dataGridView1.Rows[e.RowIndex].Cells["Cena"].Value
				);
				double stanjeNaDanPopisaKomercijalno = Convert.ToDouble(
					dataGridView1.Rows[e.RowIndex].Cells["StanjeNaDanPopisaKomercijalno"].Value
				);
				double razlika = newValueForKomercijalnoPopis - stanjeNaDanPopisaKomercijalno;
				dataGridView1.Rows[e.RowIndex].Cells["Razlika"].Value = razlika.ToString(
					"#,##0.00"
				);
				dataGridView1.Rows[e.RowIndex].Cells["VrednostRazlike"].Value =
					razlika * cenaStavkeNaDan;
				if (Convert.ToDouble(dataGridView1.Rows[e.RowIndex].Cells["Razlika"].Value) > 0)
					dataGridView1.Rows[e.RowIndex].Cells["Razlika"].Style.ForeColor = System
						.Drawing
						.Color
						.Green;
				else
			...
			else if (dataGridView1.Columns[e.ColumnIndex].Name == "PorucenaKolicina")
			{
				...
				TDOffice.StavkaPopis stavka = TDOffice
					.StavkaPopis.List()
					.Where(x => x.ID == stavkaID)
					.FirstOrDefault();
				...
				if (
					...
					&& Convert.ToInt32(
						dataGridView1
							.Rows[e.RowIndex]
							.Cells["KomercijalnoNarudzbenicaStavkaID"]
							.Value
					) != -1
				)
				{
					...
					Komercijalno.Stavka s = Komercijalno.Stavka.Get(
						DateTime.Now.Year,
						komercijalnoNarudzbenicaStavkaID
					);
					s.Kolicina = newValue;
					s.Update(DateTime.Now.Year);

					LoadKomercijalnoNarudzbenicaStavke();
					dataGridView1.Rows[e.RowIndex].Cells["PorucenaKolicina"].Value =
						_komercijalno_narudzbenica_stavke
							.Result.Where(x => x.StavkaID == komercijalnoNarudzbenicaStavkaID)
							.FirstOrDefault()
							.Kolicina;
					dataGridView1.Rows[e.RowIndex].Cells["VrednostPR"].Value =
						cenaStavkeNaDan * newValue;
				}
				dataGridView1.EndEdit();
			}
			else if (dataGridView1.Columns[e.ColumnIndex].Name == "Skart")
			{
				...
				TDOffice.StavkaPopis stavka = TDOffice
					.StavkaPopis.BufferedList(TimeSpan.FromHours(1))
					.Where(x => x.ID == stavkaID)
					.FirstOrDefault();
		...
		private void dataGridView1_ColumnSortModeChanged(
			object sender,
		...
		private void obrisiSveToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			if (
				MessageBox.Show(
					"Da li sigurno zelite obrisati sve stavke iz dokumenta?",
			...
			)
			{
				...
				if (_Komercijalno_narudzbenica != null)
					Komercijalno.Stavka.RemoveAllFromDocument(
						con,
						33,
						_Komercijalno_narudzbenica.BrDok
					);
		...
		private void stampajPopisnuListu_btn_Click(object sender, EventArgs e)
		{
			...
			Document d = dt.ToPdf(
				"TDOffice_v2 - Popisna Lista",
				"Popis br. " + _TDOffice_popis.ID.ToString(),
				new List<
					Tuple<
						string,
						MigraDoc.DocumentObjectModel.Unit,
						MigraDoc.DocumentObjectModel.ParagraphAlignment
					>
				>()
				{
					new Tuple<
						...
						MigraDoc.DocumentObjectModel.Unit,
						MigraDoc.DocumentObjectModel.ParagraphAlignment
					>("KatBr", "5cm", MigraDoc.DocumentObjectModel.ParagraphAlignment.Center),
					new Tuple<
						string,
						MigraDoc.DocumentObjectModel.Unit,
						MigraDoc.DocumentObjectModel.ParagraphAlignment
					>("Naziv", "10cm", MigraDoc.DocumentObjectModel.ParagraphAlignment.Left),
					new Tuple<
						string,
						MigraDoc.DocumentObjectModel.Unit,
						MigraDoc.DocumentObjectModel.ParagraphAlignment
					>("Kolicina", "5cm", MigraDoc.DocumentObjectModel.ParagraphAlignment.Center)
				}
			);
		...
		private void kreirajDokumentRazduzenjaZaduzenja_btn_Click(object sender, EventArgs e)
		{
			...
			{
				MessageBox.Show(
					"Ne postoji ni jedna stavka sa razlikom da bi se kreirao dokument!"
				);
				return;
			}

			int brDokZaduzenja = Komercijalno.Dokument.Insert(
				_TDOffice_popis.Datum.Year,
				16,
				"TD " + _TDOffice_popis.ID,
				null,
				"TDOffice_v2 - " + _TDOffice_popis.ID,
				1,
				_TDOffice_popis.MagacinID,
			...
			{
				MessageBox.Show(
					"Doslo je do greske prilikmo kreiranja dokumenta zaduzenja u komercijalnom poslovanju!"
				);
				return;
			}
			...
			foreach (Tuple<int, double> t in razlike)
			{
				Komercijalno.Stavka.Insert(
					DateTime.Now.Year,
					Komercijalno.Dokument.Get(_TDOffice_popis.Datum.Year, 16, brDokZaduzenja),
					_komercijalno_roba.Result.Where(x => x.ID == t.Item1).FirstOrDefault(),
					Komercijalno
						.RobaUMagacinu.BufferedList(TimeSpan.FromMinutes(10))
						.Where(x => x.MagacinID == _TDOffice_popis.MagacinID && x.RobaID == t.Item1)
						.FirstOrDefault(),
					t.Item2,
					0
				);
		...
		private void kontrolaLagera_btn_Click(object sender, EventArgs e)
		{
			...
			using (
				fm_KontrolaLagera_Index kl = new fm_KontrolaLagera_Index(
					_TDOffice_popis.MagacinID,
					list
				)
			)
		...
		private void svihRazlikaToolStripMenuItem2_Click(object sender, EventArgs e)
		{
			...
			if (
				MessageBox.Show(
					"Da li sigurno zelite generisati novi popis za stavke kojima stanje nije tacno?",
					"Potvrdi",
					MessageBoxButtons.YesNo
				) != DialogResult.Yes
			)
			...
			foreach (DataGridViewRow row in dataGridView1.Rows)
			{
				...
				double stanjeNaDanPopisaKomercijalno = Convert.ToInt32(
					row.Cells["StanjeNaDanPopisaKomercijalno"].Value
				);
				double razlika = newValueForKomercijalnoPopis - stanjeNaDanPopisaKomercijalno;
			...
			int newID = TDOffice.DokumentPopis.Insert(
			...
			using (_7_fm_TDPopis_Index pi = new _7_fm_TDPopis_Index(noviPopis))
			{
				Task.Run(() =>
				{
					pi.DodajRobuUPopis(
						Komercijalno
							.RobaUMagacinu.BufferedList(TimeSpan.FromMinutes(5))
							.Where(x => robaIDZaNoviPopis.Contains(x.RobaID))
							.ToArray()
					);
				});
		...
		private void svihRazlikaToolStripMenuItem3_Click(object sender, EventArgs e)
		{
			...
			{
				if (
					!Program.TrenutniKorisnik.ImaPravo(700806)
					&& _TDOffice_popis.SpecijalStampa != 0
				)
				{
				...
				foreach (DataGridViewRow row in dataGridView1.Rows)
				{
					int robaID = Convert.ToInt32(row.Cells["RobaID"].Value);
					double popisanaKolicina = Convert.ToDouble(row.Cells["Kolicina"].Value);
					double komercijalnoPopis = Convert.ToDouble(
						row.Cells["KomercijalnoPopisKolicina"].Value
					);
					double stanjeNaDanPopisaKomercijalno = Convert.ToDouble(
						row.Cells["StanjeNaDanPopisaKomercijalno"].Value
					);
				...
				foreach (
					var stavka in _stavke.Result.Where(x => robaIDZaNoviPopis.Contains(x.RobaID))
				)
				{
					DataRow dr = dt.NewRow();
				...
				Document d = dt.ToPdf(
					"TDOffice_v2 - Popisna Lista Svih Razlika",
					"Popis br. " + _TDOffice_popis.ID.ToString(),
					new List<
						Tuple<
							string,
		...
		private void manjkovaToolStripMenuItem1_Click(object sender, EventArgs e)
		{
			...
			Document d = dt.ToPdf(
				...
				>()
				{
					new Tuple<string, Unit, ParagraphAlignment>(
						"KatBr",
						"5cm",
		...
		private void dodeliSpecijalnuStampuToolStripMenuItem1_Click(object sender, EventArgs e)
		{
			...
			using (InputBox ib = new InputBox("Specijalna Stampa", "Unesite ID specijalne stampe"))
			{
				...
				try
				{
					...
					_TDOffice_popis.Update();
					this.stampajSpecijal_btn.Visible =
						_TDOffice_popis.SpecijalStampa >= 0 ? true : false;
					this.stampajSpecijal_btn.Text =
						$"Stampaj Specijal ({_TDOffice_popis.SpecijalStampa})";
		...
		private void detaljnaAnalizaToggleToolStripMenuItem1_Click(object sender, EventArgs e)
		{
			...
			LocalSettings.Settings.TDPopis_PrikaziDetaljnuAnalizu = !LocalSettings
				.Settings
				.TDPopis_PrikaziDetaljnuAnalizu;
			LocalSettings.Update();
			detaljnaAnalizaToggleToolStripMenuItem1.Text = LocalSettings
		...
		private void dataGridViewTextBox_KeyPress(object sender, KeyPressEventArgs e)
		{
			...
			{
				string currVal = (
					sender as DataGridViewTextBoxEditingControl
				).EditingControlFormattedValue.ToStringOrDefault();
		...
		private void prikaziZabelezenoStanjeToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			if (
				_TDOffice_popis.ZabelezenoStanjePopisa == null
				|| _TDOffice_popis.ZabelezenoStanjePopisa.Rows.Count == 0
			)
			{
			...
			using (
				DataGridViewSelectBox box = new DataGridViewSelectBox(
					_TDOffice_popis.ZabelezenoStanjePopisa
				)
			)
			{
		...
		private void dokumentomInternaOtpremnicaToolStripMenuItem_Click(object sender, EventArgs e)
		{
			if (
				Application
					.OpenForms.OfType<fm_TDPopis_SvediStanjeInternomOtpremnicom>()
					.FirstOrDefault() != null
			)
				return;
			DataTable dt = new DataTable();
			...
			{
				using (
					fm_TDPopis_SvediStanjeInternomOtpremnicom pss =
						new fm_TDPopis_SvediStanjeInternomOtpremnicom(dt, _TDOffice_popis)
				)
					if (!pss.IsDisposed)
						pss.ShowDialog();
			});
		...
		private void lagerListaPrikazanihStavkiToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			if (_lagerListaForm == null)
				_lagerListaForm = new fm_LagerListaStavki_Index(
					_stavke.Result.Select(x => x.RobaID).ToArray(),
					_TDOffice_popis.MagacinID
				);
