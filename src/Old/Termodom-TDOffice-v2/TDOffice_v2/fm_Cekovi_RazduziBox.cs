...
namespace TDOffice_v2
{
	public partial class fm_Cekovi_RazduziBox : Form
	{
		...
		{
			if (
				TDOffice.SpecifikacijaNovca.Get((int)comboBox1.SelectedValue, datumUnosa_dtp.Value)
				== null
			)
			{
				MessageBox.Show(
					"Specifikacija novca datog magazina na izabranom datumu ne postoji!"
				);
				return;
			}
			...
			MessageBox.Show(
				"Cek uspesno realizovan na datum " + datum.ToString("dd.MM.yyyy") + "!"
			);
