...
namespace TDOffice_v2.Komercijalno
{
	public static class Procedure
	{
		...
		public static double StanjeDoDatuma(
			FbConnection con,
			DateTime datum,
			int magacinID,
			int robaID
		)
		{
			using (FbCommand cmd = new FbCommand("STANJE_DO_DATUMA", con))
			{
				...
				cmd.Parameters.Add("PRETHCENA", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("PRETHNAB", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("PRETHSTANJE", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("PRETHDEVNAB", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("PRETHDEVCNA", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
		...
		public static int NapraviUslugu(
			int vrDok,
			int brDok,
			int robaID,
			double cenaBezPdv,
		...
		/// <returns></returns>
		public static Tuple<double, double> CenaNaDan(
			FbConnection con,
			int magacinID,
			int robaID,
			DateTime datum
		)
		{
			using (FbCommand cmd = new FbCommand("CENE_NA_DAN", con))
			{
				...
				return new Tuple<double, double>(
					Math.Round(Convert.ToDouble(cmd.Parameters["NABAVNACENA"].Value), 4),
					Math.Round(Convert.ToDouble(cmd.Parameters["PRODAJNACENA"].Value), 4)
				);
			}
		}
		...
		public static void SrediKarticu(
			int magacinID,
			int robaID,
			DateTime datumOd,
			bool stopNaMinus = false
		)
		{
			using (
				FbConnection con = new FbConnection(
		...
		)
		{
			using (FbCommand cmd = new FbCommand("SREDIKARTICU", con))
			{
				...
				cmd.Parameters.Add("OK", FbDbType.Integer).Direction = System
					.Data
					.ParameterDirection
					.Output;
		...
		public static Dictionary<string, double> SrediStanjePP(
			FbConnection con,
			int ppid,
			string mtID,
			DateTime datum,
		...
		)
		{
			...
			using (FbCommand cmd = new FbCommand("SREDI_STANJE_PP", con))
			{
				...
				cmd.Parameters.Add("ULAZ", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("IZLAZ", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("ULAZ_NA_DAN", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("IZLAZ_NA_DAN", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("ULAZ_NA_DAN_ROK", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("IZLAZ_NA_DAN_DOK", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("KUP_ULAZ", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("KUP_IZLAZ", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("KUP_ULAZ_NA_DAN", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("KUP_IZLAZ_NA_DAN", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("KUP_ULAZ_NA_DAN_ROK", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("KUP_IZLAZ_NA_DAN_ROK", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("DOB_ULAZ", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("DOB_IZLAZ", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("DOB_ULAZ_NA_DAN", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("DOB_IZLAZ_NA_DAN", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("DOB_ULAZ_NA_DAN_ROK", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("DOB_IZLAZ_NA_DAN_ROK", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("POC_STA", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("KUP_POC_STA", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("DOB_POC_STA", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("UK_UPLATA", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				cmd.Parameters.Add("UK_ISPLATA", FbDbType.Double).Direction = System
					.Data
					.ParameterDirection
					.Output;
				...
				dict.Add(
					"ULAZ_NA_DAN_ROK",
					Convert.ToDouble(cmd.Parameters["ULAZ_NA_DAN_ROK"].Value)
				);
				dict.Add(
					"IZLAZ_NA_DAN_DOK",
					Convert.ToDouble(cmd.Parameters["IZLAZ_NA_DAN_DOK"].Value)
				);
				...
				dict.Add(
					"KUP_ULAZ_NA_DAN",
					Convert.ToDouble(cmd.Parameters["KUP_ULAZ_NA_DAN"].Value)
				);
				dict.Add(
					"KUP_IZLAZ_NA_DAN",
					Convert.ToDouble(cmd.Parameters["KUP_IZLAZ_NA_DAN"].Value)
				);
				dict.Add(
					"KUP_ULAZ_NA_DAN_ROK",
					Convert.ToDouble(cmd.Parameters["KUP_ULAZ_NA_DAN_ROK"].Value)
				);
				dict.Add(
					"KUP_IZLAZ_NA_DAN_ROK",
					Convert.ToDouble(cmd.Parameters["KUP_IZLAZ_NA_DAN_ROK"].Value)
				);
				...
				dict.Add(
					"DOB_ULAZ_NA_DAN",
					Convert.ToDouble(cmd.Parameters["DOB_ULAZ_NA_DAN"].Value)
				);
				dict.Add(
					"DOB_IZLAZ_NA_DAN",
					Convert.ToDouble(cmd.Parameters["DOB_IZLAZ_NA_DAN"].Value)
				);
				dict.Add(
					"DOB_ULAZ_NA_DAN_ROK",
					Convert.ToDouble(cmd.Parameters["DOB_ULAZ_NA_DAN_ROK"].Value)
				);
				dict.Add(
					"DOB_IZLAZ_NA_DAN_ROK",
					Convert.ToDouble(cmd.Parameters["DOB_IZLAZ_NA_DAN_ROK"].Value)
				);
