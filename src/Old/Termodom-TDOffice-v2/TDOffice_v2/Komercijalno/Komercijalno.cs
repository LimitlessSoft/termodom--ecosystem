	...
	public static class Komercijalno
	{
		public static Dictionary<int, string> CONNECTION_STRING { get; set; } =
			new Dictionary<int, string>()
			{
				...
				{
					2020,
					"data source=4monitor; initial catalog = C:\\Poslovanje\\Baze\\2020\\FIRMA2020.FDB; user=SYSDBA; password=m; pooling=True"
				},
				{
					2019,
					"data source=4monitor; initial catalog = C:\\Poslovanje\\Baze\\2019\\FIRMA2019.FDB; user=SYSDBA; password=m; pooling=True"
				},
				{
					2018,
					"data source=4monitor; initial catalog = C:\\Poslovanje\\Baze\\2018\\FIRMA2018.FDB; user=SYSDBA; password=m; pooling=True"
				},
				{
					2017,
					"data source=4monitor; initial catalog = C:\\Poslovanje\\Baze\\2017\\FIRMA2017.FDB; user=SYSDBA; password=m; pooling=True"
				}
			};
		...
		/// <returns></returns>
		public static double GetRealnaNabavnaCena(
			int robaID,
			DateTime datum,
		...
		)
		{
			...
			{
				Dokument d = dokumentiNabavke.FirstOrDefault(x =>
			...
			Dokument dokument36 = dokumentiNabavke.FirstOrDefault(x =>
		...
		//            return ret;
		//        }
		public static double GetProsecnaNabavnaCena(
			FbConnection con,
			int robaID,
			DateTime odDatuma,
			DateTime doDatuma
