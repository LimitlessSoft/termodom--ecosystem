...
namespace TDOffice_v2.Komercijalno
{
	public class Parametri
	{
		...
		public void Update(FbConnection con)
		{
			using (
				FbCommand cmd = new FbCommand(
					"UPDATE PARAMETRI SET VREDNOST = @V, TIP = @T, OPIS = @O, MODUL_0 = @M0, MODUL_1 = @M1, MODUL_2 = @M2, MODUL_3 = @M3, MODUL_9 = @M9, "
						+ "MODUL_16 = @M16, MODUL_24 = @M24, MODUL_60 = @M60, MODUL_18 = @M18, MODUL_20 = @M20, GRUPAID = @G WHERE NAZIV = @NAZIV",
					con
				)
			)
			{
		...
		public static Parametri Get(FbConnection con, string naziv)
		{
			using (
				FbCommand cmd = new FbCommand(
					"SELECT NAZIV, VREDNOST, TIP, OPIS, MODUL_0, MODUL_1, MODUL_2, MODUL_3, MODUL_9, MODUL_16, MODUL_24, MODUL_60, MODUL_18, MODUL_20, GRUPAID FROM PARAMETRI WHERE NAZIV = @NAZIV",
					con
				)
			)
			{
				...
				using (FbDataReader dr = cmd.ExecuteReader())
					if (dr.Read())
						return new Parametri()
						{
							...
							Modul_0 =
								dr["MODUL_0"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_0"]),
							Modul_1 =
								dr["MODUL_1"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_1"]),
							Modul_2 =
								dr["MODUL_2"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_2"]),
							Modul_3 =
								dr["MODUL_3"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_3"]),
							Modul_9 =
								dr["MODUL_9"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_9"]),
							Modul_16 =
								dr["MODUL_16"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_16"]),
							Modul_24 =
								dr["MODUL_24"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_24"]),
							Modul_60 =
								dr["MODUL_60"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_60"]),
							Modul_18 =
								dr["MODUL_18"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_18"]),
							Modul_20 =
								dr["MODUL_20"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["MODUL_20"]),
							GrupaID =
								dr["GRUPAID"] is DBNull
									? null
									: (int?)Convert.ToInt32(dr["GRUPAID"])
						};
			}
		...
		public static List<Parametri> List(FbConnection con)
		{
...

			{
				using (
					FbCommand cmd = new FbCommand(
						"SELECT NAZIV, VREDNOST, TIP, OPIS, MODUL_0, MODUL_1, MODUL_2, MODUL_3, MODUL_9, MODUL_16, MODUL_24, MODUL_60, MODUL_18, MODUL_20, GRUPAID  FROM PARAMETRI",
						con
					)
				)
				using (FbDataReader dr = cmd.ExecuteReader())
