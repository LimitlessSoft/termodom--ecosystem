...
namespace TDOffice_v2
{
	public partial class Input_CheckedListBox : Form
	{
		...
		{
			get { return this.checkedListBox1.DataSource as List<Tuple<int, string>>; }
			set
			{
		...
		{
			get { return this.checkedListBox1.CheckOnClick; }
			set { this.checkedListBox1.CheckOnClick = value; }
		}
		...
		private void checkedListBox1_ItemCheck(object sender, ItemCheckEventArgs e)
		{
			if (e.NewValue == CheckState.Checked)
				...
				CheckedValues.RemoveAll(x =>
					x == (checkedListBox1.Items[e.Index] as Tuple<int, string>).Item1
				);
		}
