...
namespace TDOffice_v2.DTO.TDBrain_v3.Komercijalno
{
	public class PartnerGetDTO
	{
		...
		public static List<TDOffice_v2.Komercijalno.Partner> ToPartnerList(
			List<PartnerGetDTO> source
		)
		{
			List<TDOffice_v2.Komercijalno.Partner> list =
				new List<TDOffice_v2.Komercijalno.Partner>();
