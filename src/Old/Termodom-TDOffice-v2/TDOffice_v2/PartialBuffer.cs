...
namespace TDOffice_v2
{
    public class PartialBuffer<T>
    {
        ...
        public PartialBuffer(List funkcijaZaUcitavanjePoDatumu, MinDatum funkcijaZaUcitavanjeMinimalnogDatumaIzTabele, int periodUcitavanja)
        {
            _funkcijaZaUcitavanjePodataka = funkcijaZaUcitavanjePoDatumu;
            _funkcijaZaUcitavanjeMinimalnogDatumaIzTabele = funkcijaZaUcitavanjeMinimalnogDatumaIzTabele;
        ...
        {
            while (!_loaded && (_najranijeUcitanDatum == null || ((DateTime)_najranijeUcitanDatum).Date >= najranijeUcitanDatum.Date))
            {
            }
