	...
	public partial class fm_IzborRobe_v2_Index : Form
	{
		...
		private void fm_IzborRobe_v2_Index_Shown(object sender, EventArgs e)
		{
			if (PotvrdaKolicine == null)
				throw new Exception(
					"Ne mozete prikazati Izbor Robe bez i jednog event handlera na PotvrdaKolicine eventu!"
				);
		}
		...
		private async Task PopuniDGVAsync()
		{
			...
			foreach (
				Termodom.Data.Entities.Komercijalno.RobaUMagacinu rum in (await _robaUMagacinu)[
					MagacinID
				].Values
			)
			{
