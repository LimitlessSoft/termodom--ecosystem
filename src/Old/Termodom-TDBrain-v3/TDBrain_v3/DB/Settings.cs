namespace TDBrain_v3.DB
{
	public class Settings
	{
		...
		public static SingleConnectionString ConnectionStringTDOffice_v2 { get; set; } =
			new SingleConnectionString();
		public static ConnectionStringCollection ConnectionStringKomercijalno { get; set; } =
			new ConnectionStringCollection();
		public static SingleConnectionString ConnectionStringKomercijalnoConfig { get; set; } =
			new SingleConnectionString();
