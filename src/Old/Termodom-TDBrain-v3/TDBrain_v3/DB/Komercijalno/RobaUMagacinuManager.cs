...
namespace TDBrain_v3.DB.Komercijalno
{
	...
	public class RobaUMagacinuManager
	{
		...
		public class RobaUMagacinuCollection : IEnumerable<Dictionary<int, RobaUMagacinuManager>>
		{
			...
			public RobaUMagacinuCollection(
				Dictionary<int, Dictionary<int, RobaUMagacinuManager>> dict
			) => _dict = dict;
			...
			/// </summary>
			/// <returns></returns>
			IEnumerator<Dictionary<int, RobaUMagacinuManager>> IEnumerable<
				Dictionary<int, RobaUMagacinuManager>
			>.GetEnumerator() => _dict.Values.GetEnumerator();
		...
		public static void Insert(FbConnection con, int magacinID, int robaID)
		{
			using (
				FbCommand cmd = new FbCommand(
					"INSERT INTO ROBAUMAGACINU (MAGACINID, ROBAID) VALUES (@M, @R)",
					con
				)
			)
			{
		...
		public static List<RobaUMagacinuManager> List(
			int magacinID,
			int godina,
		...
		/// <returns></returns>
		public static RobaUMagacinuCollection Collection(
			FbConnection con,
			List<string> whereParameters = null
		)
		{
			...
			Dictionary<int, Dictionary<int, RobaUMagacinuManager>> dict =
				new Dictionary<int, Dictionary<int, RobaUMagacinuManager>>();
		...
		/// <param name="whereParameters"></param>
		/// <returns></returns>
		public static Termodom.Data.Entities.Komercijalno.RobaUMagacinuDictionary Dictionary(
			FbConnection con,
			List<string> whereParameters = null
		)
		{
			Dictionary<
				int,
				Dictionary<int, Termodom.Data.Entities.Komercijalno.RobaUMagacinu>
			> dict =
				new Dictionary<
					int,
					Dictionary<int, Termodom.Data.Entities.Komercijalno.RobaUMagacinu>
					...
					while (dr.Read())
					{
						...
						if (!dict.ContainsKey(magId))
							dict.Add(
								...
								new Dictionary<
									int,
									Termodom.Data.Entities.Komercijalno.RobaUMagacinu
								>()
							);
						...
						dict[magId]
							.Add(
								Convert.ToInt32(dr["ROBAID"]),
								new Termodom.Data.Entities.Komercijalno.RobaUMagacinu()
								{
									MagacinID = Convert.ToInt32(dr["MAGACINID"]),
									RobaID = Convert.ToInt32(dr["ROBAID"]),
									KriticneZalihe = Convert.ToDouble(dr["KRITZAL"]),
			...
			Dictionary<
				int,
				ReadOnlyDictionary<int, Termodom.Data.Entities.Komercijalno.RobaUMagacinu>
			> finalDict =
				new Dictionary<
					int,
					ReadOnlyDictionary<int, Termodom.Data.Entities.Komercijalno.RobaUMagacinu>
			...
			foreach (int key in dict.Keys)
				finalDict.Add(
					key,
					new ReadOnlyDictionary<int, Termodom.Data.Entities.Komercijalno.RobaUMagacinu>(
						dict[key]
					)
				);
