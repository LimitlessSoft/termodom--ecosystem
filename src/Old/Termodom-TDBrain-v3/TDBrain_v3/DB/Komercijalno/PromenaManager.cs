...
namespace TDBrain_v3.DB.Komercijalno
{
	...
	public class PromenaManager
	{
			...
			using (
				FbConnection con = new FbConnection(
					DB.Settings.ConnectionStringKomercijalno[
						Settings.MainMagacinKomercijalno,
						godina
					]
				)
			)
		...
		/// <param name="whereParameters"></param>
		/// <returns></returns>
		public static PromenaCollection Collection(
			FbConnection con,
						...
						dict.Add(
							...
							new PromenaManager()
							{
								...
								DatDPO =
									dr["DATDPO"] is DBNull
										? null
										: Convert.ToDateTime(dr["DATDPO"]),
								Duguje =
									dr["DUGUJE"] is DBNull ? null : Convert.ToDouble(dr["DUGUJE"]),
								Potrazuje =
								...
								DatVal =
									dr["DATVAL"] is DBNull
										? null
										: Convert.ToDateTime(dr["DATVAL"]),
								VDuguje =
									dr["VDUGUJE"] is DBNull
										? null
										: Convert.ToDouble(dr["VDUGUJE"]),
								VPotrazuje =
									dr["VPOTRAZUJE"] is DBNull
										? null
										: Convert.ToDouble(dr["VPOTRAZUJE"]),
