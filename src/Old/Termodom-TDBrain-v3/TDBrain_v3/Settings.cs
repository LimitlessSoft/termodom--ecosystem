...
namespace TDBrain_v3
{
	public static class Settings
	{
		...
		public static void Reload()
		{
			...
			if (dto != null)
			{
				DB.Settings.ConnectionStringTDOffice_v2.SetPath(
					dto.DBSettings.ConnectionStringTDOffice_v2
				);
				DB.Settings.ConnectionStringKomercijalno =
					dto.DBSettings.PutanjeDoBaza.ToConnectionStringCollection();
				...
				DB.Settings.ConnectionStringKomercijalnoConfig.SetPath(
					dto.DBSettings.ConnectionStringKomercijalnoConfig
				);
		...
		public static DTO ToDTO()
		{
			...
			dto.DBSettings.PutanjeDoBaza =
				DB.Settings.ConnectionStringKomercijalno.ToPutanjeDoBazaDTO();
			dto.DBSettings.Password = DB.Settings.Password;
			dto.DBSettings.User = DB.Settings.User;
			dto.DBSettings.ConnectionStringKomercijalnoConfig =
				DB.Settings.ConnectionStringKomercijalnoConfig.Path();
			dto.DBSettings.ConnectionStringTDOffice_v2 =
				DB.Settings.ConnectionStringTDOffice_v2.Path();
		...
		public static void Save()
		{
			File.WriteAllText(
				"serverSettings.td",
				EncryptString(EncDecKey, JsonConvert.SerializeObject(ToDTO()))
			);
		}
