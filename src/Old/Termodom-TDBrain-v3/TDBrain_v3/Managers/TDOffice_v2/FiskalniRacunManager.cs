    ...
    @INVOICE_TYPE
			...
			)
			{
				...
				cmd.Parameters.AddWithValue(
					"@DATE_AND_TIME_OF_POS",
					fiskalniRacun.DateAndTimeOfPos
				);
				...
				cmd.Parameters.AddWithValue(
					"@SDCTIME_SERVER_TIME_ZONE",
					fiskalniRacun.SDCTime_ServerTimeZone
				);
				...
				cmd.Parameters.AddWithValue(
					"@INVOICE_TYPE",
					enc.GetBytes(fiskalniRacun.InvoiceType)
				);
				cmd.Parameters.AddWithValue(
					"@TRANSACTION_TYPE",
					enc.GetBytes(fiskalniRacun.TransactionType)
				);
		...
		public static FiskalniRacunDictionary Dictionary(
			FbConnection con,
					...
					while (dr.Read())
					{
						dict.Add(
							...
							new FiskalniRacun()
							{
								...
								DateAndTimeOfPos =
									dr["DATE_AND_TIME_OF_POS"] is DBNull
										? null
										: (DateTime?)
											Convert.ToDateTime(
												dr["DATE_AND_TIME_OF_POS"],
								...
								SDCTime_ServerTimeZone = Convert.ToDateTime(
									dr["SDCTIME_SERVER_TIME_ZONE"]
								),
