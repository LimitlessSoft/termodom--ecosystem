...
namespace TDBrain_v3.Managers.TDOffice_v2
{
	...
	public class DokumentPopisManager
	{
				...
				using (FbDataReader dr = cmd.ExecuteReader())
					if (dr.Read())
						return new Termodom.Data.Entities.TDOffice_v2.Popis()
						{
							...
							Status = (Termodom.Data.Enumerators.PopisStatus)
							...
							ZaduzenjeBrDokKomercijalno =
								dr["ZADUZENJE_BRDOK_KOMERCIJALNO"] is DBNull
									? null
									: Convert.ToInt32(dr["ZADUZENJE_BRDOK_KOMERCIJALNO"]),
		...
		/// <returns></returns>
		public static Termodom.Data.Entities.TDOffice_v2.PopisDictionary Dictionary(
		...
		)
		{
			...
			Dictionary<int, Termodom.Data.Entities.TDOffice_v2.Popis> dict =
				new Dictionary<int, Termodom.Data.Entities.TDOffice_v2.Popis>();
...
WHERE 1 = 1 " + whereQuery,
				...
				using (FbDataReader dr = cmd.ExecuteReader())
					while (dr.Read())
						dict.Add(
							...
							new Termodom.Data.Entities.TDOffice_v2.Popis()
							{
								ID = Convert.ToInt32(dr["ID"]),
								Datum = Convert.ToDateTime(dr["DATUM"]),
								UserID = Convert.ToInt32(dr["USERID"]),
								...
								InterniKomentar =
									dr["INTERNI_KOMENTAR"] is DBNull
										? ""
										: dr["INTERNI_KOMENTAR"].ToString(),
								Tip = (Termodom.Data.Enumerators.PopisTip)
									Convert.ToInt32(dr["TIP"]),
								KomercijalnoPopisBrDok =
									dr["KOMERCIJALNO_POPIS_BRDOK"] is DBNull
										? null
										: Convert.ToInt32(dr["KOMERCIJALNO_POPIS_BRDOK"]),
		...
		public static int Insert(
			...
			Termodom.Data.Enumerators.PopisTip tip,
