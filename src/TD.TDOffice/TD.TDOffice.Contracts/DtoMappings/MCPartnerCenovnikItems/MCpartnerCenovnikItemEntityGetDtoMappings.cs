...
namespace TD.TDOffice.Contracts.DtoMappings.MCPartnerCenovnikItems
{
	...
	{
		public static List<MCpartnerCenovnikItemEntityGetDto> ToListDto(
			this List<MCPartnerCenovnikItemEntity> source
		)
		{
		...
		public static MCpartnerCenovnikItemEntityGetDto ToDto(
			this MCPartnerCenovnikItemEntity entity
		)
		{
