...
[ApiController]
public class MCPartnerCenovnikItemsController(
	IMCPartnerCenovnikItemManager mcPartnerCenovnikItemManager
) : ControllerBase
{
	[HttpGet]
	[Route("/mc-partner-cenovnik-items")]
	public List<MCpartnerCenovnikItemEntityGetDto> GetMultiple(
		[FromQuery] MCPartnerCenovnikItemGetRequest request
