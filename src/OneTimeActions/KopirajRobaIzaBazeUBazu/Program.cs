...
internal class Program
{
	...
	static readonly DB destination = new DB(
		$"data source=4monitor; initial catalog = {destinationString}; user=SYSDBA; password=m"
	);
	...
	static void CopyTheOnesThatDoesntExist(
		KomercijalnoDbContext sourceContext,
		KomercijalnoDbContext destinationContext
	)
	{
		// Kopiraj robu
		...
		Console.WriteLine(
			$"Pronadjeno {robaThatExistsInSourceOnly.Count} entiteta koji ne postoje u destinacionoj bazi."
		);
