...
export default {
    ...
    execution: async (driver) => {
        ...
        await driver.wait(
            until.elementIsVisible(profiKutakButton),
            ELEMENT_AWAITER_TIMEOUT
        )
        await driver.wait(
            until.elementIsEnabled(profiKutakButton),
            ELEMENT_AWAITER_TIMEOUT
        )
        ...
        await driver.wait(
            until.elementIsEnabled(usernameInput),
            ELEMENT_AWAITER_TIMEOUT
        )
        ...
        await driver.wait(
            until.elementIsEnabled(passwordInput),
            ELEMENT_AWAITER_TIMEOUT
        )
        ...
        await driver.wait(
            until.elementLocated(By.xpath('/html/body/div/div/main/div[2]/h6')),
            ELEMENT_AWAITER_TIMEOUT
        )
        ...
        await driver.wait(
            until.elementIsVisible(dodajUKorpuButton),
            ELEMENT_AWAITER_TIMEOUT
        )
        await driver.wait(
            until.elementIsEnabled(dodajUKorpuButton),
            ELEMENT_AWAITER_TIMEOUT
        )
        ...
        await driver.wait(
            until.elementIsVisible(zakljuciPorudzbinuButton),
            ELEMENT_AWAITER_TIMEOUT
        )
        await driver.wait(
            until.elementIsEnabled(zakljuciPorudzbinuButton),
            ELEMENT_AWAITER_TIMEOUT
        )
        await zakljuciPorudzbinuButton.click()

        const statusLabelLocator = By.xpath(
            '/html/body/div/div/main/div[2]/div[1]/div/div[1]/p[5]'
        )
        ...
        await driver.wait(
            until.elementIsVisible(statusLabel),
            ELEMENT_AWAITER_TIMEOUT
        )
        assert.equal(
