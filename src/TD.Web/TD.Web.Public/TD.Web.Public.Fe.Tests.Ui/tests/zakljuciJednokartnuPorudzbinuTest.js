...
export default async (driver) => {
    ...
    await driver.wait(until.elementLocated(dodajUKorpuButtonLocator), WAIT_TIMEOUT)
    ...
    await driver.wait(until.elementLocated(nacinPlacanjaFirstOptionLocator), WAIT_TIMEOUT)
