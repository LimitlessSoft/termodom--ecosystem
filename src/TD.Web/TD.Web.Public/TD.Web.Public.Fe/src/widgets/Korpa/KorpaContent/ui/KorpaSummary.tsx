        ...
        <Grid container p={2} justifyContent={`right`}>
            <Grid item>
                ...
                >
                    ...
                    >
                        Ukupno:{' '}
                        {formatNumber(props.cart.summary.valueWithoutVAT)} RSD
                    </ResponsiveTypography>
                    <ResponsiveTypography
                        sx={{
                            color: lightColor,
                    ...
                    <ResponsiveTypography scale={1.3}>
                        Za uplatu:{' '}
                        {formatNumber(props.cart.summary.valueWithVAT)} RSD
                    </ResponsiveTypography>
                    <ResponsiveTypography
                        sx={{
                        ...
                        scale={1.4}
                    >
                        Ušteda: {formatNumber(props.cart.summary.discountValue)}{' '}
                        RSD
                    </ResponsiveTypography>
                </Paper>
            </Grid>
