    ...
    <Grid m={5}>
      {currentCartLevel.nextLevelValue == null ? (
        ...
        <ResponsiveTypography align={`justify`}>
          ...
          {formatNumber(props.cart.summary.valueWithoutVAT)} i dodeljeni su Vam
          rabati stepena {currentCartLevel.currentLevel}. Ukoliko ukupna
          vrednost računa pređe {formatNumber(currentCartLevel.nextLevelValue)}{" "}
          RSD stepen rabata će biti ažuriran! *Rabat se obracunava na ukupnu
