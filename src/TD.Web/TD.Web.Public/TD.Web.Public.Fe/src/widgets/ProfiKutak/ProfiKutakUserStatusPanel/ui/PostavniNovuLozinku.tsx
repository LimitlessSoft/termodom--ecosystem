...
export const PostaviNovuLozinku = (props: IPostavniNovuLozinkuProps): JSX.Element => {
            ...
            <Dialog open={isOpened}>
                ...
                <DialogContent>
                    <Grid container spacing={2} py={2}>
                        <Grid item lg={12}>
                            <TextField fullWidth label={`Stara lozinka`} type={`password`} onChange={(e) => {
                                setOldPassword(e.target.value)
                            }} />
                        </Grid>
                        <Grid item lg={12}>
                            <TextField fullWidth label={`Nova lozinka`} type={`password`} onChange={(e) => {
                                setPassword1(e.target.value)
                            }} />
                        </Grid>
                        <Grid item lg={12}>
                            <TextField fullWidth label={`Potvrdi novu lozinku`} type={`password`}
                                onChange={(e) => {
                ...
                <DialogActions>
                    ...
                    <Button variant={`contained`} disabled={isPasswordValid === false} onClick={() => {
