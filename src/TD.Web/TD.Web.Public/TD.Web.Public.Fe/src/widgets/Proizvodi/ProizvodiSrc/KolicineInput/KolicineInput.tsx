        ...
        <Grid container
            ...
            sx={{ width: '100%', py: 2 }}>
                <InnerKolicinaInput
                    ...
                    unit={props.altUnit == null
                        ? props.baseUnit
                        : props.altUnit}
                    onPlusClick={() => {
                        props.onBaseKolicinaValueChange(Math.round(props.baseKolicina + 1))
                    }}
                    onMinusClick={() => {
                    ...
                    }} />
                {
                    props.altUnit == null ?
                        ...
                        <InnerKolicinaInput
                            onValueChange={(val: number) => {
                                props.onBaseKolicinaValueChange(val / props.oneAlternatePackageEquals)
                            }}
