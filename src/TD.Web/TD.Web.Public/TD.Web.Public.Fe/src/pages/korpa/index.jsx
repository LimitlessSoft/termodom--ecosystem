        ...
        <Box maxWidth={UIDimensions.maxWidth} margin={`auto`}>
            ...
            >
                ...
                >
                    ...
                    {cart.summary.additionalDiscountApplied && (
                        <Alert severity="success" variant={`filled`}>
                            Vaša korpa prelazi visoku vrednost te su Vam
                            odobreni dodatni rabati u odnosu na cenu koju ste
                            videli u samom proizvodu!
                        </Alert>
                    )}
                </Stack>
                <Stack
