      ...
      >
          ...
          helperText={
            isNicknameValid ? null : (
              <Grid>
                ...
                >
                  Ime i prezime mora imati između {nicknameMinLength} i{" "}
                  {nicknameMaxLength} karaktera.
                </Typography>
              </Grid>
            )
          }
            ...
            isUsernameValid ? null : (
              <Grid>
                <Typography
                  ...
                  variant={errorTextVariant}
                >
                  Korisničko ime mora imati između {usernameMinLength} i{" "}
                  {usernameMaxLength} karaktera.
                </Typography>
              </Grid>
            )
          }
        ...
        {cities == null || cities.length == 0 ? (
          ...
          <TextField
            ...
            onChange={(e) => {
              setNewUser((prev) => {
                return { ...prev, cityId: Number.parseInt(e.target.value) };
              });
            }}
          ...
          <TextField
            ...
            onChange={(e) => {
              setNewUser((prev) => {
                return {
                  ...prev,
                  favoriteStoreId: Number.parseInt(e.target.value),
                };
              });
            }}
        ...
        {isAllValid() ? null : (
          <Typography color={mainTheme.palette.error.light} sx={{ m: 2 }}>
