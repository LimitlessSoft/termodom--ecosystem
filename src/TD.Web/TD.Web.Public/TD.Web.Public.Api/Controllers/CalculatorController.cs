...
[ApiController]
public class CalculatorController(ICalculatorManager calculatorManager) : ControllerBase
{
	[HttpGet]
	...
	[HttpGet]
	[Route("/calculator")]
	public IActionResult GetCalculator([FromQuery] GetCalculatorRequest request) =>
		Ok(calculatorManager.GetCalculator(request));
}
