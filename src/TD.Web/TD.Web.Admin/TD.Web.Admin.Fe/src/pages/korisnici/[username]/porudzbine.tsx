...
import { Button, CircularProgress, Grid, Paper, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from "@mui/material"
...
const KorisnikPorudzbine = (): JSX.Element => {
    ...
    return (
        <Grid m={2}>
            ...
            { orders !== undefined && orders.length === 0 && <Typography>Nema porudžbina</Typography> }
