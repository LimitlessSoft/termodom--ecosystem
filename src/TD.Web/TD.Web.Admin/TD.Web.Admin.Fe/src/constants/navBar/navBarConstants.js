import { Home, Widgets, ListAlt, People, Settings, Article, Search } from '@mui/icons-material'
...
export const NAV_BAR_CONSTANTS = {
    ...
    MODULES: (permissions) => [
        ...
        {
            label: NAV_BAR_CONSTANTS.MODULE_LABELS.SEO_ANALYZER,
            href: URL_CONSTANTS.SEO_ANALYZER.INDEX,
            icon: <Search />,
        },
    ],
}
