...
namespace TD.Web.Common.DbMigrations.Migrations
{
    ...
    {
        private readonly string UpFile_002 = Path.Combine(Constants.DbMigrations.DbImportDataRoot, "002_MigrateProductPriceUsersLevelsData.sql");
        private readonly string DownFile_002 = Path.Combine(Constants.DbMigrations.DbImportDataDownRoot, "down_002_MigrateProductPriceUsersLevelsData.sql");
