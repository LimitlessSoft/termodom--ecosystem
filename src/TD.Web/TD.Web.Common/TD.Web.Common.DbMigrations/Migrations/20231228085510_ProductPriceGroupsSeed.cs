...
namespace TD.Web.Common.DbMigrations.Migrations
{
	...
	{
		private readonly string UpFile_005 = Path.Combine(
			LegacyConstants.DbMigrations.DbSeedsRoot,
			"005_ProductPriceGroupsSeed.sql"
		);
		private readonly string DownFile_005 = Path.Combine(
			LegacyConstants.DbMigrations.DbSeedsDownRoot,
			"down_005_ProductPriceGroupsSeed.sql"
		);
