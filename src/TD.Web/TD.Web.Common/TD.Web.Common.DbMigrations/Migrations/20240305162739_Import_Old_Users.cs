...
namespace TD.Web.Common.DbMigrations.Migrations
{
    ...
    {
        private readonly string UpFile_001 = Path.Combine(Constants.DbMigrations.DbImportDataRoot, "001_MapUsersData.sql");
        private readonly string DownFile_001 = Path.Combine(Constants.DbMigrations.DbImportDataDownRoot, "down_001_MapUsersData.sql");
