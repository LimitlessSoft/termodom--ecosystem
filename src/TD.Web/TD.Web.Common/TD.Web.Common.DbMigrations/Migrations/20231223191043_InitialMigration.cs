...
namespace TD.Web.Common.DbMigrations.Migrations
{
	public partial class InitialMigration : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					LastTimeSeen = table.Column<DateTime>(
						type: "timestamp without time zone",
						nullable: true
					),
					ProcessingDate = table.Column<DateTime>(
						type: "timestamp without time zone",
						nullable: true
					),
					IsActive = table.Column<bool>(
			...
			migrationBuilder.CreateTable(
				...
				{
					table.PrimaryKey(
						"PK_ProductEntityProductGroupEntity",
						x => new { x.GroupsId, x.ProductsId }
					);
					table.ForeignKey(
			...
			migrationBuilder.CreateIndex(name: "IX_Users_CityId", table: "Users", column: "CityId");
		...
		protected override void Down(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.DropTable(name: "ProductEntityProductGroupEntity");

			migrationBuilder.DropTable(name: "ProductPriceGroupLevel");
			...
			migrationBuilder.DropTable(name: "ProductPriceGroups");
