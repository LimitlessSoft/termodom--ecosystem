        ...
        public UpdateUserRequestValidator(WebDbContext dbContext)
        {
            ...
            RuleFor(x => x.DateOfBirth)
                ...
                .WithMessage(
                    string.Format(
                        ...
                        nameof(UpdateUserRequest.DateOfBirth)
                    )
                )
                .Custom(
                    (dateOfBirth, context) =>
            ...
            RuleFor(x => x.Mobile)
                ...
                .WithMessage(
                    string.Format(
                        LSCoreCommonValidationCodes.COMM_002.GetDescription()!,
                        nameof(UpdateUserRequest.Mobile)
                    )
                )
            ...
            RuleFor(x => x.Address)
                ...
                .WithMessage(
                    string.Format(
                        LSCoreCommonValidationCodes.COMM_002.GetDescription()!,
                        nameof(UpdateUserRequest.Address)
                    )
                )
            ...
            RuleFor(x => x.CityId)
                ...
                .WithMessage(
                    string.Format(
                        LSCoreCommonValidationCodes.COMM_002.GetDescription()!,
                        nameof(UpdateUserRequest.CityId)
                    )
                )
                .NotEmpty()
                .WithMessage(
            ...
            RuleFor(x => x.FavoriteStoreId)
                ...
                .WithMessage(
                    string.Format(
                        LSCoreCommonValidationCodes.COMM_002.GetDescription()!,
                        nameof(UpdateUserRequest.FavoriteStoreId)
                    )
                )
                .NotEmpty()
                .WithMessage(
            ...
            RuleFor(x => x.Comment)
                ...
                .WithMessage(
                    string.Format(
                        UsersValidationCodes.UVC_026.GetDescription()!,
                        _commentMaximumLength
                    )
                );
        }
    }
