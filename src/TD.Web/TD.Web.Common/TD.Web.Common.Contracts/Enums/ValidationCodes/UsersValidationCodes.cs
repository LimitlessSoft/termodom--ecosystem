...
{
	[Description("Morate uneti korisničko ime!")]
	UVC_001,
	...
	[Description("Korisničko ime može imati maksimum {0} karaktera.")]
	UVC_005,
	...
	[Description("Adresa ne može biti prazna")]
	UVC_032,

	[Description("Adresa ne može biti duža od {0} karaktera")]
	UVC_033,

	[Description("Morate izabrati omiljenu prodavnicu")]
	UVC_034,

	[Description("Morate izabrati grad")]
	UVC_035,
}
