...
namespace TD.Web.Common.Repository
{
	...
	{
		public static IIncludableQueryable<TEntity, TProperty> IncludeRecursively<
			TEntity,
			TProperty
		>(
		...
		public static IIncludableQueryable<TEntity, TProperty> ThenIncludeRecursively<
			TEntity,
			TProperty
		>(
			...
			where TEntity : class
		{
			...
			return source
				...
				.ThenIncludeRecursively(depth - 1, navigationPropertyPath);
		}
