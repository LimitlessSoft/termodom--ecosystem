    ...
    public class ProductEntityMap : LSCoreEntityMap<ProductEntity>
    {
        public override Action<EntityTypeBuilder<ProductEntity>> Mapper { get; } =
            entityTypeBuilder =>
            {
                ...
                entityTypeBuilder.Property(x => x.Src).IsRequired().HasMaxLength(64);
                ...
                entityTypeBuilder.Property(x => x.CatalogId).IsRequired(false);

                entityTypeBuilder.Property(x => x.Classification).IsRequired();

                entityTypeBuilder.Property(x => x.VAT).IsRequired();

                entityTypeBuilder.HasMany(x => x.Groups).WithMany(x => x.Products);
                ...
                entityTypeBuilder.Property(x => x.PriorityIndex).IsRequired().HasDefaultValue(0);
