...
public class InterneOtpremniceDbContext(
	DbContextOptions<InterneOtpremniceDbContext> options,
...
) : LSCoreDbContext<InterneOtpremniceDbContext>(options)
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		modelBuilder
			.Entity<InternaOtpremnicaItemEntity>()
			.AddMap(new InternaOtpremnicaItemEntityMap());
	}
}
