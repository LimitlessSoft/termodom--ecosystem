namespace TD.Office.Public.Contracts.Interfaces.IApiClients;

/// <summary>
/// This should be implemented as separate project in TD.Office.InterneOtpremnice referencing its contracts and then using here.
