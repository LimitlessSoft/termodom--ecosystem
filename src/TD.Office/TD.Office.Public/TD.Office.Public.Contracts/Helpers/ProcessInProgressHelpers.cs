...
public static class ProcessInProgressHelpers
{
    ...
    public static async Task ValidateProcessIsNotInProgressAsync(ICacheManager cacheManager, string process)
    {
    ...
    public static async Task SetProcessAsCompletedAsync(ICacheManager cacheManager, string process) =>
