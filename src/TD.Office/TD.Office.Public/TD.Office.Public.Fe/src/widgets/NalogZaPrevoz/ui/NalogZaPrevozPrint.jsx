            ...
            {!data ? (
                ...
                <Grid m={1} container>
                    <Grid item xs={12} px={13} py={4}>
                        ...
                        <Typography variant={`body1`}>
                            Kontakt: {data.mobilni}
                        </Typography>
                        <Typography variant={`body1`}>
                            Prevoznik: {data.prevoznik}
                        </Typography>
                        <Typography variant={`body1`}>
                            Ukupna cena prevoza (bez PDV):{' '}
                            {formatNumber(data.cenaPrevozaBezPdv)}
                        </Typography>
                        <Typography variant={`body1`}>
                            Od toga kupcu naplaceno (bez PDV):{' '}
                            {formatNumber(data.miNaplatiliKupcuBezPdv)}{' '}
                            {data.placenVirmanom && '(virmanom)'}
                        </Typography>
                        <Typography variant={`body1`}>
                            Napomena: {data.note}
                        </Typography>
                            ...
                            {[1, 2, 3, 4].map((item) => {
                                return (
                                    ...
                                    >
                                        ...
                                        {item === 2 && (
                                            <Typography>Robu izdao</Typography>
                                        )}
                                        {item === 3 && (
                                            <Typography>
                                                Robu prevezao
