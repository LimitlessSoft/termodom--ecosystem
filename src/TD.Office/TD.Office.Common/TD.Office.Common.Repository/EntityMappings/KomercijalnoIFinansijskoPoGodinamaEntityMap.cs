...
public class KomercijalnoIFinansijskoPoGodinamaEntityMap
	: LSCoreEntityMap<KomercijalnoIFinansijskoPoGodinamaEntity>
{
	public static readonly int _commentMaximumLength = 512;
	public override Action<
		EntityTypeBuilder<KomercijalnoIFinansijskoPoGodinamaEntity>
	> Mapper { get; } =
		(builder) =>
		{
