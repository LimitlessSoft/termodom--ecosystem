...
namespace TDOffice_v2
{
    public partial class _1389_fm_PregledDana_Index : Form
    {
        ...
        {
            List<Tuple<int, double>> list = Komercijalno.Magacin.PrometList(new DateTime(odDatuma_dtp.Value.Year, odDatuma_dtp.Value.Month, odDatuma_dtp.Value.Day));
        ...
        {
            Tuple<int, double> mesecniPromet = Komercijalno.Magacin.Promet(Convert.ToInt32(magacin_cmb.SelectedValue), new DateTime(odDatuma_dtp.Value.Year, odDatuma_dtp.Value.Month, 1), new DateTime(odDatuma_dtp.Value.Year, odDatuma_dtp.Value.Month, DateTime.DaysInMonth(odDatuma_dtp.Value.Year, odDatuma_dtp.Value.Month)));
            Tuple<int, double> danasnjiPromet = Komercijalno.Magacin.Promet(Convert.ToInt32(magacin_cmb.SelectedValue), odDatuma_dtp.Value);
            Tuple<int, double> prometGotovina = Komercijalno.Magacin.Promet(Convert.ToInt32(magacin_cmb.SelectedValue), odDatuma_dtp.Value, Komercijalno.NacinUplate.Gotovina);
            Tuple<int, double> prometVirman = Komercijalno.Magacin.Promet(Convert.ToInt32(magacin_cmb.SelectedValue), odDatuma_dtp.Value, Komercijalno.NacinUplate.Virman);
            Tuple<int, double> prometKartica = Komercijalno.Magacin.Promet(Convert.ToInt32(magacin_cmb.SelectedValue), odDatuma_dtp.Value, Komercijalno.NacinUplate.Kartica);
            Tuple<int, double> prometOdlozeno = Komercijalno.Magacin.Promet(Convert.ToInt32(magacin_cmb.SelectedValue), odDatuma_dtp.Value, Komercijalno.NacinUplate.Odlozeo);
