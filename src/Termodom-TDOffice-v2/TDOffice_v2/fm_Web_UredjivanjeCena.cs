    ...
    public partial class fm_Web_UredjivanjeCena : Form
    {
        ...
        Task<List<Komercijalno.Stavka>> komercijalnoStavkeNabavke50 = Task.Run(() =>
        {
            ...
            foreach(var dn in dokumentiNabavke50)
                foreach(var s in stavkeNabavkeMagacina.Where(x => x.VrDok == dn.VrDok && x.BrDok == dn.BrDok))
                    stavkeNabavke.Add(s);
        ...
        fm_Web_UredjivanjeCena_Item witem = new fm_Web_UredjivanjeCena_Item() { TopMost = true, TopLevel = true };
        ...
        private void UcitajStavke()
        {
            ...
            List<TDOffice.WebUredjivanjeCenaStavka> stavkeUTDOfficeu = TDOffice.WebUredjivanjeCenaStavka.List();
            ...
            foreach (var s in stavkeUTDOfficeu.Where(x => x.RobaID > 0))
            {
                ...
                var poslednjaNabavka = komercijalnoStavkeNabavke50.Result.Where(x => x.RobaID == s.RobaID).FirstOrDefault();
                var kRUM = komercijalnoRobaUMagacinu50.Result.Where(x => x.RobaID == s.RobaID).FirstOrDefault();
                var wProizvod = webProizvodi.Result.Where(x => x.RobaID == s.RobaID).FirstOrDefault();

                if (kRoba == null)
                {
                    errorOutput.Add(s.RobaID, "TDOffice_Web_Stavka koja ima dodeljeni RobaID: " + s.RobaID + " nije pronadjena u komercijalnom sifarniku robe.");
                    continue;
                }
                if (kRUM == null)
                {
                    errorOutput.Add(s.RobaID, "TDOffice_Web_Stavka koja ima dodeljeni RobaID: " + s.RobaID + " nije pronadjena u komercijalnom Robi U Magacinu 50.");
                    continue;
                }
                if(poslednjaNabavka == null)
                {
                    errorOutput.Add(s.RobaID, "TDOffice_Web_Stavka koja ima dodeljeni RobaID: " + s.RobaID + " nije pronadjena poslednja nabavka.");
                    continue;
                }
                if (wProizvod == null)
                {
                    errorOutput.Add(s.RobaID, "TDOffice_Web_Stavka koja ima dodeljeni RobaID: " + s.RobaID + " nije pronadjena kao proizvod na sajtu.");
                    continue;
                }
                ...
                dr["KomercijalnoNabavnaCena"] = poslednjaNabavka == null ? 0 : poslednjaNabavka.NabavnaCena;
                ...
                switch (s.Uslov)
                {
                    ...
                    case TDOffice.Enums.WebUredjivanjeCenaUslov.PoslednjaNabavnaCena:
                        planiranaWebNabavnaCena = poslednjaNabavka == null ? 0 : poslednjaNabavka.NabavnaCena + (poslednjaNabavka.NabavnaCena * (s.Modifikator / 100));
                        break;

                    case TDOffice.Enums.WebUredjivanjeCenaUslov.ProdajnaCena:
                        planiranaWebNabavnaCena = kRUM.ProdajnaCena + (kRUM.ProdajnaCena * (s.Modifikator / 100));
                        break;
                    ...
                    case TDOffice.Enums.WebUredjivanjeCenaUslov.ReferentniProizvod:
                        ...
                        var poslednjaNabavkaReferentnogProizvoda = komercijalnoStavkeNabavke50.Result.Where(x => x.RobaID == (int)s.ReferentniProizvod).FirstOrDefault();
                        planiranaWebNabavnaCena = poslednjaNabavkaReferentnogProizvoda.NabavnaCena + (poslednjaNabavkaReferentnogProizvoda.NabavnaCena * (s.Modifikator / 100));
                        break;
        ...
        private void ObojiPodateDgv()
        {
            ...
            {
                if (Convert.ToDouble(dataGridView1.Rows[i].Cells["TrenutnaWebNabavnaCena"].Value) != Convert.ToDouble(dataGridView1.Rows[i].Cells["PlaniranaWebNabavnaCena"].Value))
        ...
        {
            DataRow dr = (dataGridView1.DataSource as DataTable).Select("RobaID = " + webStavka.RobaID)[0];

            var kRoba = komercijalnoRoba.Result.Where(x => x.ID == webStavka.RobaID).FirstOrDefault();
            var poslednjaNabavka = komercijalnoStavkeNabavke50.Result.Where(x => x.RobaID == webStavka.RobaID).FirstOrDefault();
            var kRUM = komercijalnoRobaUMagacinu50.Result.Where(x => x.RobaID == webStavka.RobaID).FirstOrDefault();
            var wProizvod = webProizvodi.Result.Where(x => x.RobaID == webStavka.RobaID).FirstOrDefault();
            ...
            dr["ReferentniProizvod"] = webStavka.ReferentniProizvod == null ? -1 : webStavka.ReferentniProizvod;
            ...
            switch (webStavka.Uslov)
            {
                ...
                case TDOffice.Enums.WebUredjivanjeCenaUslov.PoslednjaNabavnaCena:
                    planiranaWebNabavnaCena = poslednjaNabavka == null ? 0 : poslednjaNabavka.NabavnaCena + (poslednjaNabavka.NabavnaCena * (webStavka.Modifikator / 100));
                    break;

                case TDOffice.Enums.WebUredjivanjeCenaUslov.ProdajnaCena:
                    planiranaWebNabavnaCena = kRUM.ProdajnaCena + (kRUM.ProdajnaCena * (webStavka.Modifikator / 100));
                    break;
                ...
                case TDOffice.Enums.WebUredjivanjeCenaUslov.ReferentniProizvod:
                    ...
                    var poslednjaNabavkaReferentnogProizvoda = komercijalnoStavkeNabavke50.Result.Where(x => x.RobaID == (int)webStavka.ReferentniProizvod).FirstOrDefault();
                    planiranaWebNabavnaCena = poslednjaNabavkaReferentnogProizvoda.NabavnaCena + (poslednjaNabavkaReferentnogProizvoda.NabavnaCena * (webStavka.Modifikator / 100));
                    break;
            ...
            try
            {
                ...
                switch (dataGridView1.Columns[e.ColumnIndex].Name)
                {
                    case "Modifikator":
                        ...
                        stavka.Modifikator = Convert.ToDouble(dataGridView1.Rows[e.RowIndex].Cells["Modifikator"].Value);
                        stavka.Update();
                        break;

                    case "CenaIzMagacina":
                        stavka = TDOffice.WebUredjivanjeCenaStavka.Get(robaID);
                        stavka.MagacinID = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells["CenaIzMagacina"].Value);
                        stavka.Update();
                        break;

                    case "WebNabavnaCenaUslov":
                        stavka = TDOffice.WebUredjivanjeCenaStavka.Get(robaID);
                        stavka.Uslov = (TDOffice.Enums.WebUredjivanjeCenaUslov)Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells["WebNabavnaCenaUslov"].Value);
                        stavka.Update();
                        break;
                ...
                var kRUM = komercijalnoRobaUMagacinu50.Result.Where(x => x.RobaID == robaID).FirstOrDefault();
                var poslednjaNabavka = komercijalnoStavkeNabavke50.Result.Where(x => x.RobaID == robaID).FirstOrDefault();

                double planiranaWebNabavnaCena = 0;
                TDOffice.Enums.WebUredjivanjeCenaUslov uslov = (TDOffice.Enums.WebUredjivanjeCenaUslov)dr.Cells["WebNabavnaCenaUslov"].Value;
                switch (uslov)
                {
                    case TDOffice.Enums.WebUredjivanjeCenaUslov.FiksnaCena:
                        planiranaWebNabavnaCena = Convert.ToDouble(dataGridView1.Rows[e.RowIndex].Cells["Modifikator"].Value);
                        break;

                    case TDOffice.Enums.WebUredjivanjeCenaUslov.PoslednjaNabavnaCena:
                        planiranaWebNabavnaCena = poslednjaNabavka == null ? 0 : poslednjaNabavka.NabavnaCena + (poslednjaNabavka.NabavnaCena * (Convert.ToDouble(dataGridView1.Rows[e.RowIndex].Cells["Modifikator"].Value) / 100));
                        break;

                    case TDOffice.Enums.WebUredjivanjeCenaUslov.ProdajnaCena:
                        planiranaWebNabavnaCena = kRUM.ProdajnaCena + (kRUM.ProdajnaCena * (Convert.ToDouble(dataGridView1.Rows[e.RowIndex].Cells["Modifikator"].Value) / 100));
                        break;

                    case TDOffice.Enums.WebUredjivanjeCenaUslov.ReferentniProizvod:
                        if (Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells["ReferentniProizvod"].Value) <= 0)
                        {
                            planiranaWebNabavnaCena = 0;
                            break;
                        }
                        var referentiProizvodiRobaID = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells["ReferentniProizvod"].Value);
                        var poslednjaNabavkaReferentnogProizvoda = komercijalnoStavkeNabavke50.Result.Where(x => x.RobaID == referentiProizvodiRobaID).FirstOrDefault();
                        planiranaWebNabavnaCena = poslednjaNabavkaReferentnogProizvoda.NabavnaCena + (poslednjaNabavkaReferentnogProizvoda.NabavnaCena * (Convert.ToDouble(dataGridView1.Rows[e.RowIndex].Cells["Modifikator"].Value) / 100));
                        break;
                ...
                dataGridView1.Rows[e.RowIndex].Cells["PlaniranaWebNabavnaCena"].Value = planiranaWebNabavnaCena;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (witem != null && !witem.IsDisposed && witem.Visible)
                witem.UcitajStavku(Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells["RobaID"].Value), odDatuma_dtp.Value, doDatuma_dtp.Value);
        }
        ...
        {
            if (MessageBox.Show("Da li sigurno zelite postaviti planirane cene kao stvarne cene sajta?", "Potvrdi", MessageBoxButtons.YesNo) != DialogResult.Yes)
                return;
            ...
            Task.Run(() =>
            {
                ...
                Parallel.ForEach(rows, dr =>
                {
                    try
                    {
                        TDWeb.Proizvod p = webProizvodi.Where(x => x.RobaID == Convert.ToInt32(dr["RobaID"])).FirstOrDefault();
                    ...
                    this.Invoke((MethodInvoker)delegate
                    {
                       slogova_lbl.Text = $"Azuriram nabavne cene na sajtu... ({i} / {rows.Length})";
                    });
                });
