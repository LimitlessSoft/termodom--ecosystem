...
namespace TDOffice_v2
{
    public partial class IzborRobe_DodatniFilteri : Form
    {
        ...
        public class OnFilterChangedArgs
        {
            ...
            public DodatniFilterTrenutnoStanjeRobe StanjeRobe { get; set; } = DodatniFilterTrenutnoStanjeRobe.NULL;
            public DodatniFilterKriticneOptimalneZalihe OptimalneKriticneZalihe { get; set; } = DodatniFilterKriticneOptimalneZalihe.NULL;
            /// <summary>
        ...
        private List<Komercijalno.Proizvodjac> _sviProizvodjaci = new List<Komercijalno.Proizvodjac>();
        ...
        public IzborRobe_DodatniFilteri()
        {
            ...
            this.cb_SveIspodKriticnihZaliha.Tag = DodatniFilterKriticneOptimalneZalihe.IspodKriticnihZaliha;
            this.cb_SveIspodOptimalnihZaliha.Tag = DodatniFilterKriticneOptimalneZalihe.IspodOptimalnihZaliha;
        ...
        private void SetUI()
        {
            ...
            pro.Add(new Komercijalno.Proizvodjac() { ProID = "-1", Naziv = "<izaberi proizvodjaca>" });
            ...
            dob.Add(new Komercijalno.Dobavljac() { DobavljacID = -1, Naziv = "<izaberi dobavljaca>" });
        ...
        private void cmb_Grupa_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            List<Komercijalno.PodGrupa> pgr = _svePodgrupe.Where(x => x.GrupaID == Convert.ToString(cmb_Grupa.SelectedValue)).ToList();
        ...
        private void cb_Click(object sender, EventArgs e)
        {
            ...
            {
                case "IzvorRobe":
                    _args.IzvorRobe = rb.Checked ? (DodatniFilterIzvorRobe)rb.Tag : DodatniFilterIzvorRobe.NULL;
                    ...
                    else if ((DodatniFilterIzvorRobe)rb.Tag == DodatniFilterIzvorRobe.RobaSaPrometom)
                        _args.IzvorRobeTag = new Tuple<DateTime, DateTime>(dtp_Od.Value, dtp_Do.Value);

                    break;

                case "StanjeRobe":
                    _args.StanjeRobe = rb.Checked ? (DodatniFilterTrenutnoStanjeRobe)rb.Tag : DodatniFilterTrenutnoStanjeRobe.NULL;
                    break;
                case "OptKrit":
                    _args.OptimalneKriticneZalihe = rb.Checked ? (DodatniFilterKriticneOptimalneZalihe)rb.Tag : DodatniFilterKriticneOptimalneZalihe.NULL;
                    break;
                default:
