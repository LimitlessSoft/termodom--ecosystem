...
namespace TDOffice_v2.PDFSharpARExtensions
{
    public static class PDFSharpARExtensions
    {
        ...
        public static Color TableHeaderBackground { get; private set; } = Color.FromRgb(245, 245, 245);
        ...
        /// <returns></returns>
        public static Document ToPdf(this DataTable dataTable, string title, string subTitle, List<Tuple<string, Unit, ParagraphAlignment>> columnSettings, double tableRowHeight = 10)
        {
