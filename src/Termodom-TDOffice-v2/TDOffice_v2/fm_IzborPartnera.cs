...
namespace TDOffice_v2
{
    public partial class fm_IzborPartnera : Form
    {
        ...
        private void UpdateDGV()
        {
            ...
            dataGridView1.Columns["Telefon"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
        ...
        private void dataGridView1_KeyDown(object sender, KeyEventArgs e)
        {
            if(e.KeyCode == Keys.Enter || e.KeyCode == Keys.Return)
            {
                ...
                int ppid = Convert.ToInt32(dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells["PPID"].Value);
                if (IzborPartneraSelect != null)
                    IzborPartneraSelect(new IzborPartneraSelectArgs() { PPID = ppid });
            }
        }
