...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        public static async Task<bool> InsertAsync(int ppid, string racun, int bankaID, string valuta, double stanje, int? magacinID)
        {
            var response = await TDBrain_v3.PostAsync($"/komercijalno/tekuciracun/insert", new TekuciRacunInsertRequestBody()
            {
                BankaID = bankaID,
                PPID = ppid,
                Racun = racun,
