...
namespace TDOffice_v2.Komercijalno
{
    public static class DokumentManager
    {
        ...
        public static async Task<Termodom.Data.Entities.Komercijalno.Dokument> GetAsync(int bazaId, int vrDok, int brDok, int? godinaBaze = null)
        {
            string epString = $"/komercijalno/dokument/get?bazaID={bazaId}&godina={godinaBaze ?? DateTime.Now.Year}&vrDok={vrDok}&brDok={brDok}";
        ...
        {
            string epString = $"/komercijalno/dokument/presaberi?bazaId={bazaId}&godinaBaze={godinaBaze ?? DateTime.Now.Year}&vrDok={vrDok}&brDok={brDok}";
