...
namespace TDOffice_v2
{
    public partial class fm_OdobreniRabati : Form
    {
        ...
        private List<int> _godine { get; set; } = new List<int>() {2022, 2021, 2020, 2019, 2018, 2017 };
        ...
        public fm_OdobreniRabati()
        {
            ...
            doDatuma_dtp.Value = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day - 1);
            odDatuma_dtp.Value = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day - 1);
        ...
        private void SetDGV()
        {
            ...
            dataGridView1.Columns["UKUPANPROMET"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridView1.Columns["UKUPANPROMET"].Width = 150;

            dataGridView1.Columns["UKUPANRABAT"].DefaultCellStyle.Format = "#,##0.00 RSD";
            dataGridView1.Columns["UKUPANRABAT"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridView1.Columns["UKUPANRABAT"].Width = 150;

            dataGridView1.Columns["PROCENAT"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void btn_Prikazi_Click(object sender, EventArgs e)
        {
            ...
            List<int> magacini = magacini_clb.CheckedItems
                .OfType<Komercijalno.Magacin>()
                .Select(x => x.ID)
                .ToList();
            ...
            DataTable odobreniRabatiRezultat = Models.Izvestaj.OdobreniRabati(magacini, godina, odDatuma_dtp.Value, doDatuma_dtp.Value); 
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (fm_Izvestaj_OdobreniRabati_PosaljiKaoIzvestaj or = new fm_Izvestaj_OdobreniRabati_PosaljiKaoIzvestaj(dataTable))
                or.ShowDialog();
