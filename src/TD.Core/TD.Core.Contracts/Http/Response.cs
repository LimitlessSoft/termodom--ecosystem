...
namespace TD.Core.Contracts.Http
{
	public class Response : IResponse
	{
		...
		{
			return new Response() { Status = HttpStatusCode.NotFound };
		}
	}
	...
	public class Response<TPayload> : IResponse<TPayload>
	{
		...
		{
			return new Response<TPayload>() { Status = HttpStatusCode.Forbidden };
		}

		public static Response<TPayload> Unauthorized()
		{
			return new Response<TPayload>() { Status = HttpStatusCode.Unauthorized };
		}

		public static Response<TPayload> NotFound()
		{
			return new Response<TPayload>() { Status = HttpStatusCode.NotFound };
		}
	}
}
