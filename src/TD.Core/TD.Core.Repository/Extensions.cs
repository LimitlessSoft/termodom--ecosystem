...
namespace TD.Core.Repository
{
	public static class Extensions
	{
		...
		public static void ConfigureNpgsqlDatabase<TDbContext, TStartup>(
...
#endif
			var connection =
				$"Server={postgresHost};Port={postgresPort};Userid=postgres;Password={postgresPassword};Pooling=false;MinPoolSize=1;MaxPoolSize=20;Timeout=15;Database={dbName};Include Error Detail=true;";

			return dbContextOptionsBuilder.UseNpgsql(
				connection,
				x =>
				{
