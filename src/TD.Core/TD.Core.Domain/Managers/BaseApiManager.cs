...
namespace TD.Core.Domain.Managers
{
	public abstract class BaseApiManager : IApiManager
	{
		...
		public async Task<Response<TPayload>> HandleResponseAsync<TPayload>(
		...
		public async Task<Response<TPayload>> HandleRawResponseAsync<TPayload>(
			HttpResponseMessage responseMessage
		)
		{
			var response = new Response<TPayload>();
		...
		public async Task<Response<TPayload>> GetAsync<TRequest, TPayload>(
			string endpoint,
			TRequest request
		)
		{
		...
		public async Task<Response<TPayload>> GetRawAsync<TRequest, TPayload>(
			string endpoint,
			TRequest request
		)
		{
		...
		public async Task<Response<TPayload>> PostAsync<TRequest, TPayload>(
			string endpoint,
			TRequest request
		)
		{
		...
		public async Task<Response<TPayload>> PutAsync<TRequest, TPayload>(
			string endpoint,
			TRequest request
		)
		{
		...
		public async Task<Response> PutAsync<TRequest>(
			HttpClient httpClient,
			string endpoint,
			TRequest request
		)
