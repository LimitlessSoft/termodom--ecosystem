...
namespace TD.FE.TDOffice.Api.Controllers
{
    ...
    public class MenadzmentRazduzenjeMagacinaPoOtpremnicamaController : Controller
    {
        ...
        public LSCoreResponse<MenadzmentRazduzenjeMagacinaPoOtpremnicamaPripremaDokumenataDto> PripremaDokumenata([FromQuery]PripremaDokumenataRequest request)
        {
        ...
        public LSCoreResponse RazduziMagacin([FromBody]RazduziMagacinRequest request)
        {
