...
namespace TDOffice_v2
{
    public partial class fm_PlanerPoruka_Nova : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            TDOffice.Planer.Stavka s = TDOffice.Planer.Stavka.ListByUserID((int)korisnik_cmb.SelectedValue).Where(x => x.Datum.Date == dateTimePicker1.Value.Date).FirstOrDefault();

            if (s == null)
            {
                TDOffice.Planer.Stavka.Insert((int)korisnik_cmb.SelectedValue, dateTimePicker1.Value, "***" + textBox1.Text + "***");
            }
            else
            {
            ...
            TDOffice.Poruka.Insert(new TDOffice.Poruka()
            {
                ...
                Tekst = "Nova planer stavka na datum " + dateTimePicker1.Value.ToString("dd.MM.yyyy") + ": ***" + textBox1.Text
            });
