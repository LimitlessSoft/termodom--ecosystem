...
namespace TDOffice_v2
{
    public partial class _1347_fm_PartnerPocetnoKrajnje_Index : Form
    {
        ...
        private static int[] vrDokDokumenti = new int[]
        {
            -61, -59, 0, 10, 13, 14, 15, 22, 39, 40
        };
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Thread mt = new Thread(() =>
            {
                ...
                List<Partner> partneri = sviPartneri.Result.Where(x => x.PPID >= odPPID_nud.Value && x.PPID <= doPPID_nud.Value).ToList();
                ...
                for (int i = 0; i < workers; i++)
                {
                    ...
                    Thread t1 = new Thread(() =>
                    {
                        ...
                        Dictionary<string, List<Dokument>> Wdokumenti = new Dictionary<string, List<Dokument>>();
                        ...
                        List<Partner> Wpartneri = i + 1 < workers ? partneri.Skip(toSkip).Take(toTake).ToList() : partneri.Skip(toSkip).ToList();
                        ...
                        foreach (string key in dokumenti.Keys)
                        {
                            ...
                            Thread tl = new Thread(() =>
                            {
                                string dk = key;
                                dwMRE.Set();
                                Wdokumenti.Add(dk, dokumenti[dk].Join(wPPID,
                                                                        d => d.PPID,
                                                                        p => p,
                                                                        (d, p) => d).ToList());
                                dokumentiLoaded++;
                        ...
                        foreach (Partner p in Wpartneri)
                        {
                            for (int izv = 0; izv < 3; izv++)
                            {
                                ...
                                dr["PPID"] = p.PPID;
                                dr["Partner"] = p.Naziv;
                                dr["Izvor"] = izv == 0 ? "Finansijsko Kupac" : izv == 1 ? "Finansijsko Dobavljac" : "Komercijalno";
                                ...
                                foreach (string g in godine)
                                {
                                    ...
                                    double ps = izv == 0
                                        ...
                                        : izv == 1
                                            ? GetPocetnoStanjeFinansijskoDobavljac(promene[g], p.PPID)
                                            : GetRealnoPocetnoStanjePartnera(g, p.PPID);

                                    dr["PocetnoStanje" + g] = ps;
                                    dr["KrajnjeStanje" + g] = izv == 0 ?
                ...
                Thread ft = new Thread(() =>
                {
                    ...
                    mf.Invoke((MethodInvoker)delegate
                    {
                        ...
                        if (dataGridView1.Rows.Count > 0)
                        {
                            ...
                            dataGridView1.Columns["PocetnoStanje2017"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["PocetnoStanje2017"].Width = 100;
                            dataGridView1.Columns["PocetnoStanje2017"].HeaderText = "Pocetno 2017";
                            dataGridView1.Columns["PocetnoStanje2017"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            dataGridView1.Columns["KrajnjeStanje2017"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["KrajnjeStanje2017"].Width = 100;
                            dataGridView1.Columns["KrajnjeStanje2017"].HeaderText = "Krajnje 2017";
                            dataGridView1.Columns["KrajnjeStanje2017"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

                            dataGridView1.Columns["PocetnoStanje2018"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["PocetnoStanje2018"].Width = 100;
                            dataGridView1.Columns["PocetnoStanje2018"].HeaderText = "Pocetno 2018";
                            dataGridView1.Columns["PocetnoStanje2018"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            dataGridView1.Columns["KrajnjeStanje2018"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["KrajnjeStanje2018"].Width = 100;
                            dataGridView1.Columns["KrajnjeStanje2018"].HeaderText = "Krajnje 2018";
                            dataGridView1.Columns["KrajnjeStanje2018"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

                            dataGridView1.Columns["PocetnoStanje2019"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["PocetnoStanje2019"].Width = 100;
                            dataGridView1.Columns["PocetnoStanje2019"].HeaderText = "Pocetno 2019";
                            dataGridView1.Columns["PocetnoStanje2019"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            dataGridView1.Columns["KrajnjeStanje2019"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["KrajnjeStanje2019"].Width = 100;
                            dataGridView1.Columns["KrajnjeStanje2019"].HeaderText = "Krajnje 2019";
                            dataGridView1.Columns["KrajnjeStanje2019"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

                            dataGridView1.Columns["PocetnoStanje2020"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["PocetnoStanje2020"].Width = 100;
                            dataGridView1.Columns["PocetnoStanje2020"].HeaderText = "Pocetno 2020";
                            dataGridView1.Columns["PocetnoStanje2020"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            dataGridView1.Columns["KrajnjeStanje2020"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["KrajnjeStanje2020"].Width = 100;
                            dataGridView1.Columns["KrajnjeStanje2020"].HeaderText = "Krajnje 2020";
                            dataGridView1.Columns["KrajnjeStanje2020"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

                            dataGridView1.Columns["PocetnoStanje2021"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["PocetnoStanje2021"].Width = 100;
                            dataGridView1.Columns["PocetnoStanje2021"].HeaderText = "Pocetno 2021";
                            dataGridView1.Columns["PocetnoStanje2021"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            dataGridView1.Columns["KrajnjeStanje2021"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["KrajnjeStanje2021"].Width = 100;
                            dataGridView1.Columns["KrajnjeStanje2021"].HeaderText = "Krajnje 2021";
                            dataGridView1.Columns["KrajnjeStanje2021"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

                            dataGridView1.Columns["PocetnoStanje2022"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["PocetnoStanje2022"].Width = 100;
                            dataGridView1.Columns["PocetnoStanje2022"].HeaderText = "Pocetno 2022";
                            dataGridView1.Columns["PocetnoStanje2022"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            dataGridView1.Columns["KrajnjeStanje2022"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["KrajnjeStanje2022"].Width = 100;
                            dataGridView1.Columns["KrajnjeStanje2022"].HeaderText = "Krajnje 2022";

                            dataGridView1.Columns["PocetnoStanje2023"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["PocetnoStanje2023"].Width = 100;
                            dataGridView1.Columns["PocetnoStanje2023"].HeaderText = "Pocetno 2023";
                            dataGridView1.Columns["PocetnoStanje2023"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            dataGridView1.Columns["KrajnjeStanje2023"].DefaultCellStyle.Format = "#,##0.00";
                            dataGridView1.Columns["KrajnjeStanje2023"].Width = 100;
                            dataGridView1.Columns["KrajnjeStanje2023"].HeaderText = "Krajnje 2023";
                            dataGridView1.Columns["KrajnjeStanje2023"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                            dataGridView1.Columns["KrajnjeStanje2023"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        {
            double stanje = 0;
            List<Promena> promeneKupac = promene.Where(x => x.Konto.Substring(0, Math.Min(3, x.Konto.Length)) == "204" && x.PPID == PPID).ToList();
        ...
        private double GetKrajnjeStanjeFinansijskoDobavljac(List<Promena> promene, int PPID)
        {
            ...
            List<Promena> promeneDobavljac = promene.Where(x => x.Konto.Substring(0, Math.Min(2, x.Konto.Length)) == "43" && x.PPID == PPID).ToList();
        ...
        private void _1347_fm_PartnerPocetnoKrajnje_Index_FormClosing(object sender, FormClosingEventArgs e)
        {
            while (_working)
                Thread.Sleep(50);
        }
                ...
                if (comboBox1.SelectedIndex == 1)
                {
                    ...
                    if (hPrag > 0)
                    {
                        ...
                        for (int god = 2017; god <= 2022; god++)
                        {
                            ...
                            double trenutnaRazlika = Math.Abs(krajnje[god.ToString()] - pocetno[(god + 1).ToString()]);
                    ...
                    if(vPrag > 0)
                    {
                        ...
                        DataRow kupac = redovi.CopyToDataTable().Select("Izvor = 'Finansijsko Kupac'")[0];
                        DataRow dobavljac = redovi.CopyToDataTable().Select("Izvor = 'Finansijsko Kupac'")[0];
                        DataRow komercijalno = redovi.CopyToDataTable().Select("Izvor = 'Komercijalno'")[0];

                        if (redovi.Length != 3 || kupac == null || dobavljac == null || komercijalno == null)
                        {
                            Thread t5 = new Thread(() => {
                                MessageBox.Show("Doslo je do greske prilikom selektovanja finansijskih podataka za ovog parnera. Filtriranje ce se nastaviti bez obzira na to!");
                            });
                        ...
                        for (int god = 2017; god <= 2023; god++)
                        {
                            ...
                            double trenutnaRazlika = Math.Abs(Convert.ToDouble(komercijalno["PocetnoStanje" + god.ToString()]) - Convert.ToDouble(kupac["PocetnoStanje" + god.ToString()]) + Convert.ToDouble(dobavljac["PocetnoStanje" + god.ToString()]));
                            if (maxRazlikaPocetnoStanje < trenutnaRazlika)
                                maxRazlikaPocetnoStanje = trenutnaRazlika;

                            trenutnaRazlika = Math.Abs(Convert.ToDouble(komercijalno["PocetnoStanje" + god.ToString()]) - Convert.ToDouble(kupac["KrajnjeStanje" + god.ToString()]) + Convert.ToDouble(dobavljac["KrajnjeStanje" + god.ToString()]));
        ...
        private void ColorDGV()
        {
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                if (Math.Round(Convert.ToDouble(row.Cells["KrajnjeStanje2017"].Value), 2) != Math.Round(Convert.ToDouble(row.Cells["PocetnoStanje2018"].Value), 2))
                    dataGridView1.Rows[i].Cells["PocetnoStanje2018"].Style.BackColor = Color.Coral;

                if (Math.Round(Convert.ToDouble(row.Cells["KrajnjeStanje2018"].Value), 2) != Math.Round(Convert.ToDouble(row.Cells["PocetnoStanje2019"].Value), 2))
                    dataGridView1.Rows[i].Cells["PocetnoStanje2019"].Style.BackColor = Color.Coral;

                if (Math.Round(Convert.ToDouble(row.Cells["KrajnjeStanje2019"].Value), 2) != Math.Round(Convert.ToDouble(row.Cells["PocetnoStanje2020"].Value), 2))
                    dataGridView1.Rows[i].Cells["PocetnoStanje2020"].Style.BackColor = Color.Coral;

                if (Math.Round(Convert.ToDouble(row.Cells["KrajnjeStanje2020"].Value), 2) != Math.Round(Convert.ToDouble(row.Cells["PocetnoStanje2021"].Value), 2))
                    dataGridView1.Rows[i].Cells["PocetnoStanje2021"].Style.BackColor = Color.Coral;

                if (Math.Round(Convert.ToDouble(row.Cells["KrajnjeStanje2021"].Value), 2) != Math.Round(Convert.ToDouble(row.Cells["PocetnoStanje2022"].Value), 2))
                    dataGridView1.Rows[i].Cells["PocetnoStanje2022"].Style.BackColor = Color.Coral;

                if (Math.Round(Convert.ToDouble(row.Cells["KrajnjeStanje2022"].Value), 2) != Math.Round(Convert.ToDouble(row.Cells["PocetnoStanje2023"].Value), 2))
                    dataGridView1.Rows[i].Cells["PocetnoStanje2023"].Style.BackColor = Color.Coral;

                if (row.Cells["Izvor"].Value.ToString() == "Komercijalno")
                    dataGridView1.Rows[i].DefaultCellStyle.Font = new Font(dataGridView1.DefaultCellStyle.Font, FontStyle.Bold);
            }
        }
        ...
        private double GetRealnoPocetnoStanjePartnera(string godina, int ppid)
        {
            ...
            double psKupac = istorijeUplata[godina].Where(x => x.Datum.Day == 1 && x.Datum.Month == 1 && x.VrDok == -61 && x.PPID == ppid).Sum(x => x.Iznos);
            double psDobavljac = istorijeUplata[godina].Where(x => x.Datum.Day == 1 && x.Datum.Month == 1 && x.VrDok == -59 && x.PPID == ppid).Sum(x => x.Iznos);
        ...
        public double GetRealnoKrajnjeStanjePartnera(string godina, int ppid, List<Dokument> dokumentiPartnera, List<Termodom.Data.Entities.Komercijalno.Izvod> izvodiPartnera)
        {
            ...
            foreach (Dokument dok in dokumentiPartnera.Where(x => new int[] { 10, 13, 14, 15, 22, 39, 40 }.Contains(x.VrDok)))
            {
                ...
                {
                    krajnjeStanje -= new int[] { 13, 40 }.Contains(dok.VrDok) ? dok.Duguje : dok.Potrazuje;
                    krajnjeStanje += new NacinUplate[] { NacinUplate.Gotovina, NacinUplate.Kartica }.Contains(dok.NUID) ? dok.Potrazuje : 0;
                }
                else
                {
                    krajnjeStanje += new int[] { 10, 39 }.Contains(dok.VrDok) ? dok.Duguje : dok.Potrazuje;
                    krajnjeStanje -= new int[] { 10 }.Contains(dok.VrDok) && dok.NUID == NacinUplate.Gotovina ? dok.Duguje : 0;
                }
            }
