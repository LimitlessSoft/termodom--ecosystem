...
namespace TDOffice_v2
{
    public partial class fm_PromenaReferentaDokumenta_Index : Form
    {
        ...
        {
            if (cmb_VrstaDokumenta.SelectedIndex == 0) { MessageBox.Show("Niste izabrali vrstu dokumenta"); return; }
            ...
            label4.Text = "Trenutni referent <" + cmb_VrstaDokumenta.Text + "> - " + txt_BrDok.Text + " je <"+ Config.Zaposleni.Get(dokument.RefID).Naziv + ">";
            panel2.Enabled = true;
        }
