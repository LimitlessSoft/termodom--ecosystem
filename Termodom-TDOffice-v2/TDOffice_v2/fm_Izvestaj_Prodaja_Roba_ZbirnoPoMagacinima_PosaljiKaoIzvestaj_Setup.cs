...
{
    public partial class fm_Izvestaj_Prodaja_Roba_ZbirnoPoMagacinima_PosaljiKaoIzvestaj_Setup : Form
    {
        ...
        public fm_Izvestaj_Prodaja_Roba_ZbirnoPoMagacinima_PosaljiKaoIzvestaj_Setup(DataTable data, Models.Periodi periodi, string tipIzv)
        {
            InitializeComponent();
            _data = data;
            _periodi = periodi;
            korisnicima_clb.DataSource = _tdOfficeUsers.Result;
        ...
        private void fm_Izvestaj_Prodaja_Roba_ZbirnoPoMagacinima_PosaljiKaoIzvestaj_Setup_Load(object sender, EventArgs e)
        {
        ...
        private void posalji_btn_Click(object sender, EventArgs e)
        {
            ...
            foreach (TDOffice.User u in korisnicima_clb.CheckedItems.OfType<TDOffice.User>())
            {
                ...
                string naslov = "Izvestaj Prodaje robe Zbirno ";
                ...
                TDOffice.Poruka.Insert(new TDOffice.Poruka()
                {
                    ...
                    {
                        Action = TDOffice.PorukaAction.IzvestajProdajeRobeZbirnoPoMagacinima,
                        AdditionalInfo = new Tuple<DataTable, Models.Periodi>(izvestaj, _periodi)
                    },
            ...
            using (Input_CheckedListBox cb = new Input_CheckedListBox())
            {
                ...
                Task.Run(() =>
                {
                    ...
                    DataTable reperniRezultati = _tipIzvestaja == "RSD" ?
                        Models.Izvestaj.ProdajaRobePoRealnimCenama(_periodi, CheckedValues, _listaRobe) :
                        Models.Izvestaj.ProdajaRobePoPoslednjimCenama(_periodi, CheckedValues, _listaRobe);

                    DataTable reperniDT = reperniRezultati.AsEnumerable().GroupBy(x => x.Field<int>("ROBAID")).Select(g =>
                    {
                        var row = reperniRezultati.NewRow();
