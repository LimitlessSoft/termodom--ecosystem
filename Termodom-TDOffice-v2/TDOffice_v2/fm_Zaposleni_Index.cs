...
namespace TDOffice_v2
{
    public partial class fm_Zaposleni_Index : Form
    {
        ...
        public void ReloadData()
        {
            ...
            List<TDOffice.ZaposleniUgovorORadu> zuor = TDOffice.ZaposleniUgovorORadu.List("ZAPOSLENI_ID = " + _zaposleni.ID.ToString());
        ...
        {
            using (fm_Zaposleni_UgovorOZaposljenju_Novi zu = new fm_Zaposleni_UgovorOZaposljenju_Novi(_zaposleni))
                zu.ShowDialog();
            ReloadData();
        }
        ...
        {
            if (MessageBox.Show("Sigurno zelite da uklonite ugovor?", "Uklanjanje ugovora", MessageBoxButtons.YesNo) != DialogResult.Yes)
                return;
        ...
        {
            if (MessageBox.Show("Sigurno zelite da uklonite zaposlenog?", "Uklanjanje zaposlenog", MessageBoxButtons.YesNo) != DialogResult.Yes)
                return;
