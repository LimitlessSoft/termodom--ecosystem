...
namespace TDOffice_v2.TDOffice
{
    public class FirmaManager
    {
        public static async Task<Firma> GetAsync(int id)
        {
            ...
            {
                case 200:
                    return JsonConvert.DeserializeObject<Firma>(await response.Content.ReadAsStringAsync());
                case 204:
                    return null;
                case 500:
        ...
        public static async Task<FirmaDictionary> DictionaryAsync()
        {
            ...
            {
                case 200:
                    return JsonConvert.DeserializeObject<FirmaDictionary>(await response.Content.ReadAsStringAsync());
                case 500:
                    throw new Termodom.Data.Exceptions.APIServerException();
                default:
                    throw new Termodom.Data.Exceptions.APIUnhandledStatusException(response.StatusCode);
