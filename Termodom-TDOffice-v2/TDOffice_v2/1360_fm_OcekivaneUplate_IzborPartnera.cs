...
namespace TDOffice_v2
{
    public partial class _1360_fm_OcekivaneUplate_IzborPartnera : Form
    {
        ...
        private async void LoadPartnerAsync()
        {
            ...
            foreach(Komercijalno.Partner partneri in (await Komercijalno.Partner.ListAsync()).OrderBy(x=> x.PPID))
            {
        ...
        private void _1360_fm_OcekivaneUplate_IzborPartnera_FormClosing(object sender, FormClosingEventArgs e)
        {
