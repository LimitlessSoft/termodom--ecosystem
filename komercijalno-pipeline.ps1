...
docker run -p 32778:80 -e ConnectionString_Komercijalno=$env:ConnectionStrings_KomercijalnoFransiza2026TCMD --name termodom--komercijalno-api-TCMD-2026 -m 1G --restart=always -d limitlesssoft/termodom--komercijalno-api:$env:BUILD_NUMBER
