...
docker stop termodom--komercijalno-api-TCMD-2026
# docker stop termodom--komercijalno-api-develop-TCMD-2026
docker rm termodom--komercijalno-api-TCMD-2026
# docker rm termodom--komercijalno-api-develop-TCMD-2026
...
docker stop termodom--komercijalno-api-VHEMZA-2026
docker rm termodom--komercijalno-api-VHEMZA-2026
docker stop termodom--komercijalno-api-VHEMZA-2025
docker rm termodom--komercijalno-api-VHEMZA-2025

docker stop termodom--komercijalno-api-TD-2026
docker rm termodom--komercijalno-api-TD-2026
...
docker stop termodom--komercijalno-api-SasaPdv-2026
docker rm termodom--komercijalno-api-SasaPdv-2026
...
docker stop termodom--komercijalno-api-Magacin-2026
docker rm termodom--komercijalno-api-Magacin-2026
...
docker run -p 34000:80 -e ConnectionString_Komercijalno=$env:ConnectionStrings_KomercijalnoFransiza2026TCMD --name termodom--komercijalno-api-TCMD-2026 -m 1G --restart=always -d limitlesssoft/termodom--komercijalno-api:$env:BUILD_NUMBER
...
docker run -p 33001:80 -e ConnectionString_Komercijalno=$env:ConnectionStrings_KomercijalnoFransiza2026VHEMZA --name termodom--komercijalno-api-VHEMZA-2026 -m 1G --restart=always -d limitlesssoft/termodom--komercijalno-api:$env:BUILD_NUMBER
...
docker run -p 32801:80 -e ConnectionString_Komercijalno=$env:ConnectionStrings_KomercijalnoTermodom2026 --name termodom--komercijalno-api-TD-2026 -m 1G --restart=always -d limitlesssoft/termodom--komercijalno-api:$env:BUILD_NUMBER
...
docker run -p 32874:80 -e ConnectionString_Komercijalno=$env:ConnectionStrings_KomercijalnoFransiza2026SasaPdv --name termodom--komercijalno-api-SasaPdv-2026 -m 1G --restart=always -d limitlesssoft/termodom--komercijalno-api:$env:BUILD_NUMBER
...
docker run -p 32901:80 -e ConnectionString_Komercijalno=$env:ConnectionStrings_KomercijalnoFransiza2026Magacin --name termodom--komercijalno-api-Magacin-2026 -m 1G --restart=always -d limitlesssoft/termodom--komercijalno-api:$env:BUILD_NUMBER
