...
docker run -p 33770:80 -e API_HOST=$env:API_HOST --name termodom--tdoffice-fe-api -m 1G --restart=always -d limitlesssoft/termodom--web-veleprodaja-api:$env:BUILD_NUMBER